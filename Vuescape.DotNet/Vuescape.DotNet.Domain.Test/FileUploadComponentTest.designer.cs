...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<FileUploadComponent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<FileUploadComponent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<FileUploadComponent>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<FileUploadComponent>();

                        var result = new SystemUnderTestExpectedStringRepresentation<FileUploadComponent>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.FileUploadComponent: TypeName = {systemUnderTest.TypeName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Payload = {systemUnderTest.Payload?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<FileUploadComponent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<FileUploadComponent>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<FileUploadComponent>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'payload' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new FileUploadComponent(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<FileUploadComponent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<FileUploadComponent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<FileUploadComponent>
                {
                    Name = "Payload should return same 'payload' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<FileUploadComponent>();

                        var result = new SystemUnderTestExpectedPropertyValue<FileUploadComponent>
                        {
                            SystemUnderTest = new FileUploadComponent(
        ...
        private static readonly DeepCloneWithTestScenarios<FileUploadComponent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<FileUploadComponent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<FileUploadComponent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<FileUploadComponent>().ThatIs(_ => !systemUnderTest.Payload.IsEqualTo(_.Payload));

                        var result = new SystemUnderTestDeepCloneWithValue<FileUploadComponent>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly FileUploadComponent ReferenceObjectForEquatableTestScenarios = A.Dummy<FileUploadComponent>();

        private static readonly EquatableTestScenarios<FileUploadComponent> EquatableTestScenarios = new EquatableTestScenarios<FileUploadComponent>()
            .AddScenario(() =>
                new EquatableTestScenario<FileUploadComponent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new FileUploadComponent[]
                    {
                        new FileUploadComponent(
                                ReferenceObjectForEquatableTestScenarios.Payload),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new FileUploadComponent[]
                    {
                        new FileUploadComponent(
                                A.Dummy<FileUploadComponent>().Whose(_ => !_.Payload.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Payload)).Payload),
                    },
        ...
        private static readonly ValidModelTestScenarios<FileUploadComponent> ValidModelTestScenarios = new ValidModelTestScenarios<FileUploadComponent>()
            .AddScenario(() =>
                new ValidModelTestScenario<FileUploadComponent>
                {
                    Name = "a dummy FileUploadComponent should be valid",
                    SystemUnderTest = A.Dummy<FileUploadComponent>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void FileUploadComponent___Should_implement_IModel_of_FileUploadComponent___When_reflecting()
            {
                // Arrange
                var type = typeof(FileUploadComponent);

                var expectedModelMethods = typeof(IModel<FileUploadComponent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<FileUploadComponent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void FileUploadComponent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(FileUploadComponent);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (FileUploadComponent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (FileUploadComponent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(FileUploadComponent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
            ...
            public static void DeepCloneWithTypeName___Should_throw_NotSupportedException___When_called()
            {
                ...
                actual.Message.AsTest().Must().BeEqualTo("The constructor in-use (by code gen) for FileUploadComponent does not have a parameter that corresponds with the 'TypeName' property.  As such, this method, DeepCloneWithTypeName(string typeName), cannot utilize the specified 'typeName' value for that property.");
            }
        }
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<FileUploadComponent>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                FileUploadComponent systemUnderTest1 = null;
                FileUploadComponent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    FileUploadComponent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneComponent_of_FileUploadComponentPayload___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    PaneComponent<FileUploadComponentPayload> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((PaneComponent<FileUploadComponentPayload>)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneComponent_of_FileUploadComponentPayload___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((PaneComponent<FileUploadComponentPayload>)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneComponent_of_FileUploadComponentPayload___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((PaneComponent<FileUploadComponentPayload>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneComponent_of_FileUploadComponentPayload___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((PaneComponent<FileUploadComponentPayload>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneComponent_of_FileUploadComponentPayload___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((PaneComponent<FileUploadComponentPayload>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FileUploadComponent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FileUploadComponent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FileUploadComponent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FileUploadComponent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FileUploadComponent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
