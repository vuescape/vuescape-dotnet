...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class UiObjectTest
    {
        ...
        private static readonly ValidModelTestScenarios<UiObject> ValidModelTestScenarios = new ValidModelTestScenarios<UiObject>()
            .AddScenario(() =>
                new ValidModelTestScenario<UiObject>
                {
                    Name = "a dummy UiObject should be valid",
                    SystemUnderTest = A.Dummy<UiObject>(),
                });
