...
namespace Vuescape.DotNet.Domain
{
    ...
    public partial class Section : IModel<Section>
    {
        ...
        {
            var result = Invariant($"Vuescape.DotNet.Domain.Section: Id = {this.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, TreeTable = {this.TreeTable?.ToString() ?? "<null>"}, Title = {this.Title?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
