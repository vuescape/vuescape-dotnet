...
namespace Vuescape.DotNet.Domain
{
    ...
    [Serializable]
    public partial class CssStyleWrapper : IModel<CssStyleWrapper>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="CssStyleWrapper"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(CssStyleWrapper left, CssStyleWrapper right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="CssStyleWrapper"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(CssStyleWrapper left, CssStyleWrapper right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(CssStyleWrapper other)
        {
            ...
            var result = this.CssStyle.IsEqualTo(other.CssStyle, StringComparer.Ordinal);

            return result;
        }

        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as CssStyleWrapper);
        ...
        /// <inheritdoc />
        public CssStyleWrapper DeepClone()
        {
        ...
        /// <returns>New <see cref="CssStyleWrapper" /> using the specified <paramref name="cssStyle" /> for <see cref="CssStyle" /> and a deep clone of every other property.</returns>
        ...
        public CssStyleWrapper DeepCloneWithCssStyle(string cssStyle)
        {
            var result = new CssStyleWrapper(
                                 cssStyle);
        ...
        {
            var result = Invariant($"Vuescape.DotNet.Domain.CssStyleWrapper: CssStyle = {this.CssStyle?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.CssStyle, options, propertyPathTracker, nameof(this.CssStyle));
