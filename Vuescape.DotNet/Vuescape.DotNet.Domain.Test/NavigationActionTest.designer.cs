...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<NavigationAction> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<NavigationAction>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<NavigationAction>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<NavigationAction>();

                        var result = new SystemUnderTestExpectedStringRepresentation<NavigationAction>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.NavigationAction: TypeName = {systemUnderTest.TypeName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Payload = {systemUnderTest.Payload?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<NavigationAction> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<NavigationAction>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<NavigationAction>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<NavigationAction> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<NavigationAction>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<NavigationAction>
                {
                    Name = "Payload should return same 'payload' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<NavigationAction>();

                        var result = new SystemUnderTestExpectedPropertyValue<NavigationAction>
                        {
                            SystemUnderTest = new NavigationAction(
        ...
        private static readonly DeepCloneWithTestScenarios<NavigationAction> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<NavigationAction>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<NavigationAction>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<NavigationAction>().ThatIs(_ => !systemUnderTest.Payload.IsEqualTo(_.Payload));

                        var result = new SystemUnderTestDeepCloneWithValue<NavigationAction>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly NavigationAction ReferenceObjectForEquatableTestScenarios = A.Dummy<NavigationAction>();

        private static readonly EquatableTestScenarios<NavigationAction> EquatableTestScenarios = new EquatableTestScenarios<NavigationAction>()
            .AddScenario(() =>
                new EquatableTestScenario<NavigationAction>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new NavigationAction[]
                    {
                        new NavigationAction(
                                ReferenceObjectForEquatableTestScenarios.Payload),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new NavigationAction[]
                    {
                        new NavigationAction(
                                A.Dummy<NavigationAction>().Whose(_ => !_.Payload.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Payload)).Payload),
                    },
        ...
        private static readonly ValidModelTestScenarios<NavigationAction> ValidModelTestScenarios = new ValidModelTestScenarios<NavigationAction>()
            .AddScenario(() =>
                new ValidModelTestScenario<NavigationAction>
                {
                    Name = "a dummy NavigationAction should be valid",
                    SystemUnderTest = A.Dummy<NavigationAction>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void NavigationAction___Should_implement_IModel_of_NavigationAction___When_reflecting()
            {
                // Arrange
                var type = typeof(NavigationAction);

                var expectedModelMethods = typeof(IModel<NavigationAction>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<NavigationAction>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void NavigationAction___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(NavigationAction);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (NavigationAction)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (NavigationAction)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(NavigationAction).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
            ...
            public static void DeepCloneWithTypeName___Should_throw_NotSupportedException___When_called()
            {
                ...
                actual.Message.AsTest().Must().BeEqualTo("The constructor in-use (by code gen) for NavigationAction does not have a parameter that corresponds with the 'TypeName' property.  As such, this method, DeepCloneWithTypeName(string typeName), cannot utilize the specified 'typeName' value for that property.");
            }
        }
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<NavigationAction>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                NavigationAction systemUnderTest1 = null;
                NavigationAction systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    NavigationAction systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NavigationAction___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NavigationAction___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NavigationAction___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NavigationAction___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NavigationAction___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
