    ...
    public partial class ObcToVuescapeConversionContext : IModel<ObcToVuescapeConversionContext>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ReportConversionMode, options, propertyPathTracker, nameof(this.ReportConversionMode));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.QueryString, options, propertyPathTracker, nameof(this.QueryString));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.BaseUrlToken, options, propertyPathTracker, nameof(this.BaseUrlToken));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.BaseUrl, options, propertyPathTracker, nameof(this.BaseUrl));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ShouldSummaryRowsDisplayInFooter, options, propertyPathTracker, nameof(this.ShouldSummaryRowsDisplayInFooter));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
