...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class TreeTableRowTest
    {
        ...
        private static readonly ValidModelTestScenarios<TreeTableRow> ValidModelTestScenarios = new ValidModelTestScenarios<TreeTableRow>()
            .AddScenario(() =>
                new ValidModelTestScenario<TreeTableRow>
                {
                    Name = "a dummy TreeTableRow should be valid",
                    SystemUnderTest = A.Dummy<TreeTableRow>(),
                });
