...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<TableRow> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<TableRow>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<TableRow>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TableRow>();

                        var result = new SystemUnderTestExpectedStringRepresentation<TableRow>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.TableRow: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Cells = {systemUnderTest.Cells?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<TableRow> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<TableRow>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TableRow>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'id' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<TableRow>();
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TableRow>
                {
                    Name = "constructor should throw ArgumentException when parameter 'cells' is an empty dictionary scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<TableRow>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "cells", "is an empty dictionary", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TableRow>
                {
                    Name = "constructor should throw ArgumentException when parameter 'cells' contains a key-value pair with a null value scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<TableRow>();

                        var dictionaryWithNullValue = referenceObject.Cells.ToDictionary(_ => _.Key, _ => _.Value);
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "cells", "contains at least one key-value pair with a null value", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<TableRow> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<TableRow>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TableRow>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<TableRow>
                        {
                            SystemUnderTest = new TableRow(
                                                      referenceObject.Id,
                                                      referenceObject.Cells),
        ...
        private static readonly DeepCloneWithTestScenarios<TableRow> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<TableRow>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableRow>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TableRow>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<TableRow>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableRow>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TableRow>().ThatIs(_ => !systemUnderTest.Cells.IsEqualTo(_.Cells));
        ...
        private static readonly TableRow ReferenceObjectForEquatableTestScenarios = A.Dummy<TableRow>();

        private static readonly EquatableTestScenarios<TableRow> EquatableTestScenarios = new EquatableTestScenarios<TableRow>()
            .AddScenario(() =>
                new EquatableTestScenario<TableRow>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new TableRow[]
                    {
                        new TableRow(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Cells),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new TableRow[]
                    {
                        new TableRow(
                                A.Dummy<TableRow>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.Cells),
                        new TableRow(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<TableRow>().Whose(_ => !_.Cells.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Cells)).Cells),
                    },
        ...
        private static readonly ValidModelTestScenarios<TableRow> ValidModelTestScenarios = new ValidModelTestScenarios<TableRow>()
            .AddScenario(() =>
                new ValidModelTestScenario<TableRow>
                {
                    Name = "a dummy TableRow should be valid",
                    SystemUnderTest = A.Dummy<TableRow>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void TableRow___Should_implement_IModel_of_TableRow___When_reflecting()
            {
                // Arrange
                var type = typeof(TableRow);

                var expectedModelMethods = typeof(IModel<TableRow>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<TableRow>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void TableRow___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(TableRow);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (TableRow)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Id", "Cells" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (TableRow)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(TableRow).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                TableRow systemUnderTest1 = null;
                TableRow systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableRow___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableRow___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableRow___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableRow___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableRow___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
