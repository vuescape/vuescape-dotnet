...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ColumnSorter> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ColumnSorter>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ColumnSorter>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ColumnSorter> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ColumnSorter>()
            .AddScenario(() =>
                ...
                {
                    Name = "SortDirection should return same 'sortDirection' parameter passed to constructor when getting",
        ...
        private static readonly DeepCloneWithTestScenarios<ColumnSorter> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ColumnSorter>()
            .AddScenario(() =>
                ...
                {
                    Name = "DeepCloneWithSortDirection should deep clone object and replace SortDirection with the provided sortDirection",
                    WithPropertyName = "SortDirection",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ColumnSorter>();

                        var referenceObject = A.Dummy<ColumnSorter>().ThatIs(_ => !systemUnderTest.SortDirection.IsEqualTo(_.SortDirection));

                        var result = new SystemUnderTestDeepCloneWithValue<ColumnSorter>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.SortDirection,
                        };
        ...
        private static readonly EquatableTestScenarios<ColumnSorter> EquatableTestScenarios = new EquatableTestScenarios<ColumnSorter>()
            .AddScenario(() =>
                new EquatableTestScenario<ColumnSorter>
                {
                    Name = "Default Code Generated Scenario",
        ...
        private static readonly ValidModelTestScenarios<ColumnSorter> ValidModelTestScenarios = new ValidModelTestScenarios<ColumnSorter>()
            .AddScenario(() =>
                new ValidModelTestScenario<ColumnSorter>
                {
                    Name = "a dummy ColumnSorter should be valid",
                    SystemUnderTest = A.Dummy<ColumnSorter>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ColumnSorter___Should_implement_IModel_of_ColumnSorter___When_reflecting()
            {
                // Arrange
                var type = typeof(ColumnSorter);

                var expectedModelMethods = typeof(IModel<ColumnSorter>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ColumnSorter>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ColumnSorter___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ColumnSorter);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ColumnSorter)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ColumnSorter)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ColumnSorter).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ColumnSorter>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ColumnSorter systemUnderTest1 = null;
                ColumnSorter systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ColumnSorter systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ColumnSorter___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ColumnSorter___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ColumnSorter___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ColumnSorter___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ColumnSorter___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
