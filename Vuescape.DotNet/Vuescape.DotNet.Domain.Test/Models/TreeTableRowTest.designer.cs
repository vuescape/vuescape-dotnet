...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class TreeTableRowTest
    {
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TreeTableRow>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TreeTableRow>().ThatIs(_ => !systemUnderTest.CssStyle.IsEqualTo(_.CssStyle));
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Id", "Cells", "CssClasses", "CssStyle", "Renderer", "Depth", "IsExpandable", "IsExpanded", "IsVisible", "IsSelected", "IsFocused", "Links", "Children" };
