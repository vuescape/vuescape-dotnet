...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<PaneLayout> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<PaneLayout>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<PaneLayout>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<PaneLayout>();

                        var result = new SystemUnderTestExpectedStringRepresentation<PaneLayout>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.PaneLayout: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Sections = {systemUnderTest.Sections?.ToString() ?? "<null>"}, PaneWidthPercent = {systemUnderTest.PaneWidthPercent.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<PaneLayout> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<PaneLayout>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<PaneLayout>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new PaneLayout(
                                             referenceObject.Id,
                                             new PaneSection[0].Concat(referenceObject.Sections).Concat(new PaneSection[] { null }).Concat(referenceObject.Sections).ToList(),
                                             referenceObject.PaneWidthPercent);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<PaneLayout> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<PaneLayout>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<PaneLayout>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<PaneLayout>
                        {
                            SystemUnderTest = new PaneLayout(
                                                      referenceObject.Id,
                                                      referenceObject.Sections,
                                                      referenceObject.PaneWidthPercent),
        ...
        private static readonly DeepCloneWithTestScenarios<PaneLayout> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<PaneLayout>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PaneLayout>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PaneLayout>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<PaneLayout>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PaneLayout>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PaneLayout>().ThatIs(_ => !systemUnderTest.Sections.IsEqualTo(_.Sections));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PaneLayout>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PaneLayout>().ThatIs(_ => !systemUnderTest.PaneWidthPercent.IsEqualTo(_.PaneWidthPercent));
        ...
        private static readonly PaneLayout ReferenceObjectForEquatableTestScenarios = A.Dummy<PaneLayout>();

        private static readonly EquatableTestScenarios<PaneLayout> EquatableTestScenarios = new EquatableTestScenarios<PaneLayout>()
            .AddScenario(() =>
                new EquatableTestScenario<PaneLayout>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new PaneLayout[]
                    {
                        new PaneLayout(
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new PaneLayout[]
                    {
                        new PaneLayout(
                                A.Dummy<PaneLayout>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.Sections,
                                ReferenceObjectForEquatableTestScenarios.PaneWidthPercent),
                        new PaneLayout(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<PaneLayout>().Whose(_ => !_.Sections.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Sections)).Sections,
                                ReferenceObjectForEquatableTestScenarios.PaneWidthPercent),
                        new PaneLayout(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Sections,
                                A.Dummy<PaneLayout>().Whose(_ => !_.PaneWidthPercent.IsEqualTo(ReferenceObjectForEquatableTestScenarios.PaneWidthPercent)).PaneWidthPercent),
                    },
        ...
        public static class Structural
        {
            ...
            public static void PaneLayout___Should_implement_IModel_of_PaneLayout___When_reflecting()
            {
                // Arrange
                var type = typeof(PaneLayout);

                var expectedModelMethods = typeof(IModel<PaneLayout>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<PaneLayout>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void PaneLayout___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(PaneLayout);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (PaneLayout)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Id", "Sections", "PaneWidthPercent" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (PaneLayout)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(PaneLayout).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<PaneLayout>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                PaneLayout systemUnderTest1 = null;
                PaneLayout systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    PaneLayout systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneLayout___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneLayout___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneLayout___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneLayout___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneLayout___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
