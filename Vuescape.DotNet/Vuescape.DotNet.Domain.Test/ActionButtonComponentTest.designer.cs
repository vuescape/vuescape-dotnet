...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class ActionButtonComponentTest
    {
        ...
        private static readonly ValidModelTestScenarios<ActionButtonComponent> ValidModelTestScenarios = new ValidModelTestScenarios<ActionButtonComponent>()
            .AddScenario(() =>
                new ValidModelTestScenario<ActionButtonComponent>
                {
                    Name = "a dummy ActionButtonComponent should be valid",
                    SystemUnderTest = A.Dummy<ActionButtonComponent>(),
                });
