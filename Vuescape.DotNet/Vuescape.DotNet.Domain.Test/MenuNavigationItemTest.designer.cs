...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<MenuNavigationItem> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<MenuNavigationItem>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<MenuNavigationItem>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<MenuNavigationItem> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<MenuNavigationItem>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<MenuNavigationItem>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'menuTitlePath' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<MenuNavigationItem>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "menuTitlePath", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<MenuNavigationItem>
                {
                    Name = "constructor should throw ArgumentException when parameter 'menuTitlePath' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<MenuNavigationItem>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "menuTitlePath", "white space", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<MenuNavigationItem> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<MenuNavigationItem>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<MenuNavigationItem>
                {
                    Name = "MenuTitlePath should return same 'menuTitlePath' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<MenuNavigationItem>();
        ...
        private static readonly DeepCloneWithTestScenarios<MenuNavigationItem> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<MenuNavigationItem>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MenuNavigationItem>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<MenuNavigationItem>().ThatIs(_ => !systemUnderTest.Link.IsEqualTo(_.Link));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MenuNavigationItem>
                {
                    Name = "DeepCloneWithMenuTitlePath should deep clone object and replace MenuTitlePath with the provided menuTitlePath",
                    WithPropertyName = "MenuTitlePath",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<MenuNavigationItem>();

                        var referenceObject = A.Dummy<MenuNavigationItem>().ThatIs(_ => !systemUnderTest.MenuTitlePath.IsEqualTo(_.MenuTitlePath));

                        var result = new SystemUnderTestDeepCloneWithValue<MenuNavigationItem>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.MenuTitlePath,
                        };
        ...
        private static readonly EquatableTestScenarios<MenuNavigationItem> EquatableTestScenarios = new EquatableTestScenarios<MenuNavigationItem>()
            .AddScenario(() =>
                new EquatableTestScenario<MenuNavigationItem>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new MenuNavigationItem[]
                    {
        ...
        public static class Structural
        {
            ...
            public static void MenuNavigationItem___Should_implement_IModel_of_MenuNavigationItem___When_reflecting()
            {
                // Arrange
                var type = typeof(MenuNavigationItem);

                var expectedModelMethods = typeof(IModel<MenuNavigationItem>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<MenuNavigationItem>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MenuNavigationItem___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MenuNavigationItem);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (MenuNavigationItem)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (MenuNavigationItem)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(MenuNavigationItem).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
            ...
            public static void DeepCloneWithKind___Should_throw_NotSupportedException___When_called()
            {
                ...
                actual.Message.AsTest().Must().BeEqualTo("The constructor in-use (by code gen) for MenuNavigationItem does not have a parameter that corresponds with the 'Kind' property.  As such, this method, DeepCloneWithKind(NavigationItemKind kind), cannot utilize the specified 'kind' value for that property.");
            }
        }
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<MenuNavigationItem>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                MenuNavigationItem systemUnderTest1 = null;
                MenuNavigationItem systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    MenuNavigationItem systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MenuNavigationItem___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MenuNavigationItem___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MenuNavigationItem___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MenuNavigationItem___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MenuNavigationItem___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
