...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<PaneSection> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<PaneSection>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<PaneSection>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<PaneSection>();

                        var result = new SystemUnderTestExpectedStringRepresentation<PaneSection>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.PaneSection: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Items = {systemUnderTest.Items?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<PaneSection> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<PaneSection>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<PaneSection>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new PaneSection(
                                             referenceObject.Id,
                                             new PaneItem[0].Concat(referenceObject.Items).Concat(new PaneItem[] { null }).Concat(referenceObject.Items).ToList());
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<PaneSection> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<PaneSection>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<PaneSection>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<PaneSection>
                        {
                            SystemUnderTest = new PaneSection(
                                                      referenceObject.Id,
                                                      referenceObject.Items),
        ...
        private static readonly DeepCloneWithTestScenarios<PaneSection> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<PaneSection>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PaneSection>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PaneSection>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<PaneSection>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PaneSection>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PaneSection>().ThatIs(_ => !systemUnderTest.Items.IsEqualTo(_.Items));
        ...
        private static readonly PaneSection ReferenceObjectForEquatableTestScenarios = A.Dummy<PaneSection>();

        private static readonly EquatableTestScenarios<PaneSection> EquatableTestScenarios = new EquatableTestScenarios<PaneSection>()
            .AddScenario(() =>
                new EquatableTestScenario<PaneSection>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new PaneSection[]
                    {
                        new PaneSection(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Items),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new PaneSection[]
                    {
                        new PaneSection(
                                A.Dummy<PaneSection>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.Items),
                        new PaneSection(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<PaneSection>().Whose(_ => !_.Items.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Items)).Items),
                    },
        ...
        private static readonly ValidModelTestScenarios<PaneSection> ValidModelTestScenarios = new ValidModelTestScenarios<PaneSection>()
            .AddScenario(() =>
                new ValidModelTestScenario<PaneSection>
                {
                    Name = "a dummy PaneSection should be valid",
                    SystemUnderTest = A.Dummy<PaneSection>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void PaneSection___Should_implement_IModel_of_PaneSection___When_reflecting()
            {
                // Arrange
                var type = typeof(PaneSection);

                var expectedModelMethods = typeof(IModel<PaneSection>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<PaneSection>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void PaneSection___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(PaneSection);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (PaneSection)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Id", "Items" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (PaneSection)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(PaneSection).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<PaneSection>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                PaneSection systemUnderTest1 = null;
                PaneSection systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    PaneSection systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneSection___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneSection___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneSection___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneSection___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneSection___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
