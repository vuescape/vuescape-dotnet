...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly PaneComponentBase ReferenceObjectForEquatableTestScenarios = A.Dummy<PaneComponentBase>();

        private static readonly EquatableTestScenarios<PaneComponentBase> EquatableTestScenarios = new EquatableTestScenarios<PaneComponentBase>()
            .AddScenario(() =>
                new EquatableTestScenario<PaneComponentBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new PaneComponentBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new PaneComponentBase[]
                    {
                        ...
                        // (PaneComponentBase)ReferenceObjectForEquatableTestScenarios.DeepCloneWithTypeName(A.Dummy<PaneComponentBase>().Whose(_ => !_.TypeName.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TypeName)).TypeName),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new PaneComponentBase[]
                    {
                        A.Dummy<PaneComponentBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void PaneComponentBase___Should_implement_IModel_of_PaneComponentBase___When_reflecting()
            {
                // Arrange
                var type = typeof(PaneComponentBase);

                var expectedModelMethods = typeof(IModel<PaneComponentBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<PaneComponentBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void PaneComponentBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(PaneComponentBase);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<PaneComponentBase>();

                // Act
                var actual = (PaneComponentBase)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<PaneComponentBase>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                PaneComponentBase systemUnderTest1 = null;
                PaneComponentBase systemUnderTest2 = null;
