...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class MetadataLineItemTest
    {
        ...
        private static readonly ValidModelTestScenarios<MetadataLineItem> ValidModelTestScenarios = new ValidModelTestScenarios<MetadataLineItem>()
            .AddScenario(() =>
                new ValidModelTestScenario<MetadataLineItem>
                {
                    Name = "a dummy MetadataLineItem should be valid",
                    SystemUnderTest = A.Dummy<MetadataLineItem>(),
                });
