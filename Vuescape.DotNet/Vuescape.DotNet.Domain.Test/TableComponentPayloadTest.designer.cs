...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class TableComponentPayloadTest
    {
                ...
                new StringRepresentationTestScenario<TableComponentPayload>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<TableComponentPayload>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.TableComponentPayload: Headers = {systemUnderTest.Headers?.ToString() ?? "<null>"}, Rows = {systemUnderTest.Rows?.ToString() ?? "<null>"}."),
                        };
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TableComponentPayload>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new TableComponentPayload(
                                             new string[0].Concat(referenceObject.Headers).Concat(new string[] { null }).Concat(referenceObject.Headers).ToList(),
                                             referenceObject.Rows);
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TableComponentPayload>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new TableComponentPayload(
                                             referenceObject.Headers,
                                             new IReadOnlyList<string>[0].Concat(referenceObject.Rows).Concat(new IReadOnlyList<string>[] { null }).Concat(referenceObject.Rows).ToList());
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableComponentPayload>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TableComponentPayload>().ThatIs(_ => !systemUnderTest.Headers.IsEqualTo(_.Headers));
        ...
        private static readonly EquatableTestScenarios<TableComponentPayload> EquatableTestScenarios = new EquatableTestScenarios<TableComponentPayload>()
            .AddScenario(() =>
                new EquatableTestScenario<TableComponentPayload>
                {
                    ...
                    {
                        new TableComponentPayload(
                                A.Dummy<TableComponentPayload>().Whose(_ => !_.Headers.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Headers)).Headers,
                                ReferenceObjectForEquatableTestScenarios.Rows),
                        new TableComponentPayload(
                                ReferenceObjectForEquatableTestScenarios.Headers,
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Headers", "Rows" };
