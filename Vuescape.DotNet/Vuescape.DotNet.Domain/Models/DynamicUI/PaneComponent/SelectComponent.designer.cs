...
namespace Vuescape.DotNet.Domain
{
    ...
    [Serializable]
    public partial class SelectComponent : IModel<SelectComponent>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="SelectComponent"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(SelectComponent left, SelectComponent right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="SelectComponent"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(SelectComponent left, SelectComponent right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(SelectComponent other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as SelectComponent);
        ...
        {
            throw new NotSupportedException("The constructor in-use (by code gen) for SelectComponent does not have a parameter that corresponds with the 'TypeName' property.  As such, this method, DeepCloneWithTypeName(string typeName), cannot utilize the specified 'typeName' value for that property.");
        }
        ...
        {
            var result = Invariant($"Vuescape.DotNet.Domain.SelectComponent: TypeName = {this.TypeName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Payload = {this.Payload?.ToString() ?? "<null>"}.");
