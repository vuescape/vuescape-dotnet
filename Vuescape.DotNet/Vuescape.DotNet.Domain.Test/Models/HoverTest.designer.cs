...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Hover> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Hover>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Hover>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<Hover>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.Hover: Content = {systemUnderTest.Content?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Title = {systemUnderTest.Title?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, ContentKind = {systemUnderTest.ContentKind.ToString() ?? "<null>"}, Component = {systemUnderTest.Component?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Hover> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Hover>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Hover>
                {
                    Name = "constructor should throw ArgumentException when parameter 'content' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<Hover>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "content", "white space", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<Hover> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Hover>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Hover>
                {
                    Name = "ContentKind should return same 'contentKind' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Hover>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<Hover>
                        {
                            SystemUnderTest = new Hover(
                                                      ...
                                                      referenceObject.ContentKind,
                                                      referenceObject.Component),
                            ExpectedPropertyValue = referenceObject.ContentKind,
                        };

                        return result;
                    },
                    PropertyName = "ContentKind",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Hover>
                {
        ...
        private static readonly DeepCloneWithTestScenarios<Hover> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Hover>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Hover>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Hover>().ThatIs(_ => !systemUnderTest.Content.IsEqualTo(_.Content));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Hover>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Hover>().ThatIs(_ => !systemUnderTest.Title.IsEqualTo(_.Title));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Hover>
                {
                    Name = "DeepCloneWithContentKind should deep clone object and replace ContentKind with the provided contentKind",
                    WithPropertyName = "ContentKind",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Hover>();

                        var referenceObject = A.Dummy<Hover>().ThatIs(_ => !systemUnderTest.ContentKind.IsEqualTo(_.ContentKind));

                        var result = new SystemUnderTestDeepCloneWithValue<Hover>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ContentKind,
                        };
        ...
        private static readonly Hover ReferenceObjectForEquatableTestScenarios = A.Dummy<Hover>();

        private static readonly EquatableTestScenarios<Hover> EquatableTestScenarios = new EquatableTestScenarios<Hover>()
            .AddScenario(() =>
                new EquatableTestScenario<Hover>
                {
                    Name = "Default Code Generated Scenario",
                    ...
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Hover[]
                    {
                        new Hover(
                                ...
                                ReferenceObjectForEquatableTestScenarios.ContentKind,
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new Hover[]
                    {
                        new Hover(
                                ReferenceObjectForEquatableTestScenarios.Title,
                                A.Dummy<Hover>().Whose(_ => !_.Content.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Content)).Content,
                                ReferenceObjectForEquatableTestScenarios.ContentKind,
                                ReferenceObjectForEquatableTestScenarios.Component),
                        new Hover(
                        ...
                        new Hover(
                                ReferenceObjectForEquatableTestScenarios.Title,
                                ReferenceObjectForEquatableTestScenarios.Content,
                                A.Dummy<Hover>().Whose(_ => !_.ContentKind.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ContentKind)).ContentKind,
                                ReferenceObjectForEquatableTestScenarios.Component),
                        new Hover(
                                ReferenceObjectForEquatableTestScenarios.Title,
                                ReferenceObjectForEquatableTestScenarios.Content,
        ...
        private static readonly ValidModelTestScenarios<Hover> ValidModelTestScenarios = new ValidModelTestScenarios<Hover>()
            .AddScenario(() =>
                new ValidModelTestScenario<Hover>
                {
                    Name = "a dummy Hover should be valid",
                    SystemUnderTest = A.Dummy<Hover>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void Hover___Should_implement_IModel_of_Hover___When_reflecting()
            {
                // Arrange
                var type = typeof(Hover);

                var expectedModelMethods = typeof(IModel<Hover>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Hover>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Hover___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Hover);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Hover)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Content", "Title", "ContentKind", "Component" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Hover)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(Hover).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                Hover systemUnderTest1 = null;
                Hover systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Hover___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Hover___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Hover___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Hover___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Hover___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
