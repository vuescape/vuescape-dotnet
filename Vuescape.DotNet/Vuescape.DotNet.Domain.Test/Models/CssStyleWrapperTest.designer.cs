...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CssStyleWrapper> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CssStyleWrapper>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CssStyleWrapper>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CssStyleWrapper>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CssStyleWrapper>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.CssStyleWrapper: CssStyle = {systemUnderTest.CssStyle?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CssStyleWrapper> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CssStyleWrapper>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CssStyleWrapper>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'cssStyle' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new CssStyleWrapper(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CssStyleWrapper> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CssStyleWrapper>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CssStyleWrapper>
                {
                    Name = "CssStyle should return same 'cssStyle' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CssStyleWrapper>();

                        var result = new SystemUnderTestExpectedPropertyValue<CssStyleWrapper>
                        {
                            SystemUnderTest = new CssStyleWrapper(
        ...
        private static readonly DeepCloneWithTestScenarios<CssStyleWrapper> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CssStyleWrapper>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CssStyleWrapper>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CssStyleWrapper>().ThatIs(_ => !systemUnderTest.CssStyle.IsEqualTo(_.CssStyle));

                        var result = new SystemUnderTestDeepCloneWithValue<CssStyleWrapper>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly CssStyleWrapper ReferenceObjectForEquatableTestScenarios = A.Dummy<CssStyleWrapper>();

        private static readonly EquatableTestScenarios<CssStyleWrapper> EquatableTestScenarios = new EquatableTestScenarios<CssStyleWrapper>()
            .AddScenario(() =>
                new EquatableTestScenario<CssStyleWrapper>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CssStyleWrapper[]
                    {
                        new CssStyleWrapper(
                                ReferenceObjectForEquatableTestScenarios.CssStyle),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CssStyleWrapper[]
                    {
                        new CssStyleWrapper(
                                A.Dummy<CssStyleWrapper>().Whose(_ => !_.CssStyle.IsEqualTo(ReferenceObjectForEquatableTestScenarios.CssStyle)).CssStyle),
                    },
        ...
        private static readonly ValidModelTestScenarios<CssStyleWrapper> ValidModelTestScenarios = new ValidModelTestScenarios<CssStyleWrapper>()
            .AddScenario(() =>
                new ValidModelTestScenario<CssStyleWrapper>
                {
                    Name = "a dummy CssStyleWrapper should be valid",
                    SystemUnderTest = A.Dummy<CssStyleWrapper>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void CssStyleWrapper___Should_implement_IModel_of_CssStyleWrapper___When_reflecting()
            {
                // Arrange
                var type = typeof(CssStyleWrapper);

                var expectedModelMethods = typeof(IModel<CssStyleWrapper>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CssStyleWrapper>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CssStyleWrapper___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CssStyleWrapper);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CssStyleWrapper)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "CssStyle" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CssStyleWrapper)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CssStyleWrapper).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CssStyleWrapper>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                CssStyleWrapper systemUnderTest1 = null;
                CssStyleWrapper systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CssStyleWrapper systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CssStyleWrapper___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CssStyleWrapper___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CssStyleWrapper___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CssStyleWrapper___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CssStyleWrapper___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
