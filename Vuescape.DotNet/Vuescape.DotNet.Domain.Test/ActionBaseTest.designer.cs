...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly ActionBase ReferenceObjectForEquatableTestScenarios = A.Dummy<ActionBase>();

        private static readonly EquatableTestScenarios<ActionBase> EquatableTestScenarios = new EquatableTestScenarios<ActionBase>()
            .AddScenario(() =>
                new EquatableTestScenario<ActionBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ActionBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ActionBase[]
                    {
                        ...
                        // (ActionBase)ReferenceObjectForEquatableTestScenarios.DeepCloneWithTypeName(A.Dummy<ActionBase>().Whose(_ => !_.TypeName.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TypeName)).TypeName),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new ActionBase[]
                    {
                        A.Dummy<ActionBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void ActionBase___Should_implement_IModel_of_ActionBase___When_reflecting()
            {
                // Arrange
                var type = typeof(ActionBase);

                var expectedModelMethods = typeof(IModel<ActionBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ActionBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ActionBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ActionBase);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ActionBase>();

                // Act
                var actual = (ActionBase)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ActionBase>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ActionBase systemUnderTest1 = null;
                ActionBase systemUnderTest2 = null;
