...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<SelectNavigationAction> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<SelectNavigationAction>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<SelectNavigationAction>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<SelectNavigationAction>();

                        var result = new SystemUnderTestExpectedStringRepresentation<SelectNavigationAction>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.SelectNavigationAction: TypeName = {systemUnderTest.TypeName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Payload = {systemUnderTest.Payload?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<SelectNavigationAction> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<SelectNavigationAction>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SelectNavigationAction>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<SelectNavigationAction> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<SelectNavigationAction>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SelectNavigationAction>
                {
                    Name = "Payload should return same 'payload' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<SelectNavigationAction>();

                        var result = new SystemUnderTestExpectedPropertyValue<SelectNavigationAction>
                        {
                            SystemUnderTest = new SelectNavigationAction(
        ...
        private static readonly DeepCloneWithTestScenarios<SelectNavigationAction> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<SelectNavigationAction>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SelectNavigationAction>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<SelectNavigationAction>().ThatIs(_ => !systemUnderTest.Payload.IsEqualTo(_.Payload));

                        var result = new SystemUnderTestDeepCloneWithValue<SelectNavigationAction>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly SelectNavigationAction ReferenceObjectForEquatableTestScenarios = A.Dummy<SelectNavigationAction>();

        private static readonly EquatableTestScenarios<SelectNavigationAction> EquatableTestScenarios = new EquatableTestScenarios<SelectNavigationAction>()
            .AddScenario(() =>
                new EquatableTestScenario<SelectNavigationAction>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new SelectNavigationAction[]
                    {
                        new SelectNavigationAction(
                                ReferenceObjectForEquatableTestScenarios.Payload),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new SelectNavigationAction[]
                    {
                        new SelectNavigationAction(
                                A.Dummy<SelectNavigationAction>().Whose(_ => !_.Payload.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Payload)).Payload),
                    },
        ...
        private static readonly ValidModelTestScenarios<SelectNavigationAction> ValidModelTestScenarios = new ValidModelTestScenarios<SelectNavigationAction>()
            .AddScenario(() =>
                new ValidModelTestScenario<SelectNavigationAction>
                {
                    Name = "a dummy SelectNavigationAction should be valid",
                    SystemUnderTest = A.Dummy<SelectNavigationAction>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void SelectNavigationAction___Should_implement_IModel_of_SelectNavigationAction___When_reflecting()
            {
                // Arrange
                var type = typeof(SelectNavigationAction);

                var expectedModelMethods = typeof(IModel<SelectNavigationAction>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<SelectNavigationAction>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void SelectNavigationAction___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(SelectNavigationAction);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (SelectNavigationAction)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (SelectNavigationAction)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(SelectNavigationAction).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
            ...
            public static void DeepCloneWithTypeName___Should_throw_NotSupportedException___When_called()
            {
                ...
                actual.Message.AsTest().Must().BeEqualTo("The constructor in-use (by code gen) for SelectNavigationAction does not have a parameter that corresponds with the 'TypeName' property.  As such, this method, DeepCloneWithTypeName(string typeName), cannot utilize the specified 'typeName' value for that property.");
            }
        }
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<SelectNavigationAction>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                SelectNavigationAction systemUnderTest1 = null;
                SelectNavigationAction systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    SelectNavigationAction systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ActionBase___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    ActionBase systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ActionBase)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ActionBase___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ActionBase)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ActionBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ActionBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ActionBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ActionBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ActionBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ActionBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SelectNavigationAction___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SelectNavigationAction___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SelectNavigationAction___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SelectNavigationAction___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SelectNavigationAction___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
