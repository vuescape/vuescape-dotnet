...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly LinkedResourceOpBase ReferenceObjectForEquatableTestScenarios = A.Dummy<LinkedResourceOpBase>();

        private static readonly EquatableTestScenarios<LinkedResourceOpBase> EquatableTestScenarios = new EquatableTestScenarios<LinkedResourceOpBase>()
            .AddScenario(() =>
                new EquatableTestScenario<LinkedResourceOpBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new LinkedResourceOpBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new LinkedResourceOpBase[]
                    {
                        ...
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithLinkedResource(A.Dummy<LinkedResourceOpBase>().Whose(_ => !_.LinkedResource.IsEqualTo(ReferenceObjectForEquatableTestScenarios.LinkedResource)).LinkedResource),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new LinkedResourceOpBase[]
                    {
                        A.Dummy<LinkedResourceOpBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class StructuralTesting
        {
            ...
            public static void LinkedResourceOpBase___Should_implement_IModel_of_LinkedResourceOpBase___When_reflecting()
            {
                // Arrange
                var type = typeof(LinkedResourceOpBase);

                var expectedModelMethods = typeof(IModel<LinkedResourceOpBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<LinkedResourceOpBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void LinkedResourceOpBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(LinkedResourceOpBase);
        ...
        public static class CloningTesting
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<LinkedResourceOpBase>();

                // Act
                var actual = (LinkedResourceOpBase)systemUnderTest.Clone();
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<LinkedResourceOpBase>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                LinkedResourceOpBase systemUnderTest1 = null;
                LinkedResourceOpBase systemUnderTest2 = null;
