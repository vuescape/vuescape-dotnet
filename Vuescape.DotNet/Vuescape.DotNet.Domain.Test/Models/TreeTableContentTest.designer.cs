    ...
    public static partial class TreeTableContentTest
    {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<TreeTableContent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<TreeTableContent>()
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TreeTableContent>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'footers' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<TreeTableContent>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "footers", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TreeTableContent>
                {
                    Name = "constructor should throw ArgumentException when parameter 'footers' is an empty enumerable scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<TreeTableContent>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "footers", "is an empty enumerable", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TreeTableContent>
                {
                    Name = "constructor should throw ArgumentException when parameter 'footers' contains a null element scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<TreeTableContent>();
                        ...
                        var result = new TreeTableContent(
                                             referenceObject.Headers,
                                             referenceObject.Rows,
                                             new TreeTableRow[0].Concat(referenceObject.Footers).Concat(new TreeTableRow[] { null }).Concat(referenceObject.Footers).ToList(),
                                             referenceObject.ShouldScrollVertical,
                                             referenceObject.ShouldScrollHorizontal,
                                             referenceObject.ShouldSyncHeaderScroll,
                                             referenceObject.ShouldSyncFooterScroll,
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "footers", "contains at least one null element", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TreeTableContent>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<TreeTableContent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<TreeTableContent>()
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TreeTableContent>
                {
                    Name = "Footers should return same 'footers' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<TreeTableContent>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<TreeTableContent>
                        {
                            SystemUnderTest = new TreeTableContent(
                                                      ...
                                                      referenceObject.CssStyles,
                                                      referenceObject.SortLevel),
                            ExpectedPropertyValue = referenceObject.Footers,
                        };

                        return result;
                    },
                    PropertyName = "Footers",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TreeTableContent>
                {
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TreeTableContent>
                {
                    Name = "SortLevel should return same 'sortLevel' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<TreeTableContent>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<TreeTableContent>
                        {
                            SystemUnderTest = new TreeTableContent(
                                                      ...
                                                      referenceObject.CssStyles,
                                                      referenceObject.SortLevel),
                            ExpectedPropertyValue = referenceObject.SortLevel,
                        };

                        return result;
                    },
                    PropertyName = "SortLevel",
                });
        ...
        private static readonly DeepCloneWithTestScenarios<TreeTableContent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<TreeTableContent>()
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TreeTableContent>
                {
                    Name = "DeepCloneWithFooters should deep clone object and replace Footers with the provided footers",
                    WithPropertyName = "Footers",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TreeTableContent>();

                        var referenceObject = A.Dummy<TreeTableContent>().ThatIs(_ => !systemUnderTest.Footers.IsEqualTo(_.Footers));

                        var result = new SystemUnderTestDeepCloneWithValue<TreeTableContent>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Footers,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TreeTableContent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TreeTableContent>().ThatIs(_ => !systemUnderTest.CssStyles.IsEqualTo(_.CssStyles));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TreeTableContent>
                {
                    Name = "DeepCloneWithSortLevel should deep clone object and replace SortLevel with the provided sortLevel",
                    WithPropertyName = "SortLevel",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TreeTableContent>();

                        var referenceObject = A.Dummy<TreeTableContent>().ThatIs(_ => !systemUnderTest.SortLevel.IsEqualTo(_.SortLevel));

                        var result = new SystemUnderTestDeepCloneWithValue<TreeTableContent>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.SortLevel,
                        };
                ...
                new EquatableTestScenario<TreeTableContent>
                {
                    ...
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new TreeTableContent[]
                    {
                        new TreeTableContent(
                                ...
                                ReferenceObjectForEquatableTestScenarios.Footers,
                                ...
                                ReferenceObjectForEquatableTestScenarios.SortLevel),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new TreeTableContent[]
                    {
                        ...
                        new TreeTableContent(
                                ReferenceObjectForEquatableTestScenarios.Headers,
                                ReferenceObjectForEquatableTestScenarios.Rows,
                                A.Dummy<TreeTableContent>().Whose(_ => !_.Footers.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Footers)).Footers,
                                ReferenceObjectForEquatableTestScenarios.ShouldScrollVertical,
                                ReferenceObjectForEquatableTestScenarios.ShouldScrollHorizontal,
                                ReferenceObjectForEquatableTestScenarios.ShouldSyncHeaderScroll,
                                ReferenceObjectForEquatableTestScenarios.ShouldSyncFooterScroll,
                        ...
                        new TreeTableContent(
                                ...
                                ReferenceObjectForEquatableTestScenarios.MaxRows,
                                ReferenceObjectForEquatableTestScenarios.CssClass,
                                A.Dummy<TreeTableContent>().Whose(_ => !_.CssStyles.IsEqualTo(ReferenceObjectForEquatableTestScenarios.CssStyles)).CssStyles,
                                ReferenceObjectForEquatableTestScenarios.SortLevel),
                        new TreeTableContent(
                                ReferenceObjectForEquatableTestScenarios.Headers,
                                ReferenceObjectForEquatableTestScenarios.Rows,
                                ...
                                ReferenceObjectForEquatableTestScenarios.CssClass,
                                ReferenceObjectForEquatableTestScenarios.CssStyles,
                                A.Dummy<TreeTableContent>().Whose(_ => !_.SortLevel.IsEqualTo(ReferenceObjectForEquatableTestScenarios.SortLevel)).SortLevel),
                    },
        ...
        private static readonly ValidModelTestScenarios<TreeTableContent> ValidModelTestScenarios = new ValidModelTestScenarios<TreeTableContent>()
            .AddScenario(() =>
                new ValidModelTestScenario<TreeTableContent>
                {
                    Name = "a dummy TreeTableContent should be valid",
                    SystemUnderTest = A.Dummy<TreeTableContent>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.Footers == null)
                {
                    actual.Footers.AsTest().Must().BeNull();
                }
                else if (!actual.Footers.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.Footers.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.Footers);
                }
            ...
            {
                var propertyNames = new string[] { "Headers", "Rows", "Footers", "ShouldScrollVertical", "ShouldScrollHorizontal", "ShouldSyncHeaderScroll", "ShouldSyncFooterScroll", "ShouldIncludeFooter", "DeadAreaColor", "MaxRows", "CssClass", "CssStyles", "SortLevel" };
