...
namespace Vuescape.DotNet.Domain
{
    ...
    [Serializable]
    public partial class Badge : IModel<Badge>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="Badge"/> are equal.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="Badge"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        ...
        public bool Equals(Badge other)
        {
            ...
            var result = this.Text.IsEqualTo(other.Text, StringComparer.Ordinal)
                      && this.Severity.IsEqualTo(other.Severity);

            return result;
        }

        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as Badge);
        ...
        /// <returns>New <see cref="Badge" /> using the specified <paramref name="text" /> for <see cref="Text" /> and a deep clone of every other property.</returns>
        ...
        public Badge DeepCloneWithText(string text)
        {
            var result = new Badge(
                                 text,
                                 this.Severity?.DeepClone());
        ...
        /// <summary>
        /// Deep clones this object with a new <see cref="Severity" />.
        /// </summary>
        /// <param name="severity">The new <see cref="Severity" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="Badge" /> using the specified <paramref name="severity" /> for <see cref="Severity" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public Badge DeepCloneWithSeverity(BadgeSeverity? severity)
        {
            var result = new Badge(
                                 this.Text?.DeepClone(),
                                 severity);
        ...
        {
            var result = Invariant($"Vuescape.DotNet.Domain.Badge: Text = {this.Text?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Severity = {this.Severity?.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Severity, options, propertyPathTracker, nameof(this.Severity));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
