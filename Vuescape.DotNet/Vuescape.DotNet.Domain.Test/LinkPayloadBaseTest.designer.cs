...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly LinkPayloadBase ReferenceObjectForEquatableTestScenarios = A.Dummy<LinkPayloadBase>();

        private static readonly EquatableTestScenarios<LinkPayloadBase> EquatableTestScenarios = new EquatableTestScenarios<LinkPayloadBase>()
            .AddScenario(() =>
                new EquatableTestScenario<LinkPayloadBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new LinkPayloadBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new LinkPayloadBase[]
                    {
        ...
        public static class Structural
        {
            ...
            public static void LinkPayloadBase___Should_implement_IModel_of_LinkPayloadBase___When_reflecting()
            {
                // Arrange
                var type = typeof(LinkPayloadBase);

                var expectedModelMethods = typeof(IModel<LinkPayloadBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<LinkPayloadBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void LinkPayloadBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(LinkPayloadBase);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<LinkPayloadBase>();

                // Act
                var actual = (LinkPayloadBase)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<LinkPayloadBase>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                LinkPayloadBase systemUnderTest1 = null;
                LinkPayloadBase systemUnderTest2 = null;
