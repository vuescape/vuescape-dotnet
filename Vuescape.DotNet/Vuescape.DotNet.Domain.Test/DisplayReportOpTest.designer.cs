...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class DisplayReportOpTest
    {
        ...
        private static readonly ValidModelTestScenarios<DisplayReportOp> ValidModelTestScenarios = new ValidModelTestScenarios<DisplayReportOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<DisplayReportOp>
                {
                    Name = "a dummy DisplayReportOp should be valid",
                    SystemUnderTest = A.Dummy<DisplayReportOp>(),
                });
