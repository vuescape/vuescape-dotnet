...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<HandleLinkClickClientBehavior> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<HandleLinkClickClientBehavior>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<HandleLinkClickClientBehavior>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<HandleLinkClickClientBehavior>();

                        var result = new SystemUnderTestExpectedStringRepresentation<HandleLinkClickClientBehavior>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.HandleLinkClickClientBehavior: Name = {systemUnderTest.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<HandleLinkClickClientBehavior> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<HandleLinkClickClientBehavior>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<HandleLinkClickClientBehavior>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<HandleLinkClickClientBehavior>().ThatIs(_ => !systemUnderTest.Name.IsEqualTo(_.Name));

                        var result = new SystemUnderTestDeepCloneWithValue<HandleLinkClickClientBehavior>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly HandleLinkClickClientBehavior ReferenceObjectForEquatableTestScenarios = A.Dummy<HandleLinkClickClientBehavior>();

        private static readonly EquatableTestScenarios<HandleLinkClickClientBehavior> EquatableTestScenarios = new EquatableTestScenarios<HandleLinkClickClientBehavior>()
            .AddScenario(() =>
                new EquatableTestScenario<HandleLinkClickClientBehavior>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new HandleLinkClickClientBehavior[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new HandleLinkClickClientBehavior[]
                    {
                        new HandleLinkClickClientBehavior
                            {
                                Name = A.Dummy<HandleLinkClickClientBehavior>().Whose(_ => !_.Name.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Name)).Name,
                            },
                    },
        ...
        public static class Structural
        {
            ...
            public static void HandleLinkClickClientBehavior___Should_implement_IModel_of_HandleLinkClickClientBehavior___When_reflecting()
            {
                // Arrange
                var type = typeof(HandleLinkClickClientBehavior);

                var expectedModelMethods = typeof(IModel<HandleLinkClickClientBehavior>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<HandleLinkClickClientBehavior>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void HandleLinkClickClientBehavior___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(HandleLinkClickClientBehavior);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (HandleLinkClickClientBehavior)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (HandleLinkClickClientBehavior)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(HandleLinkClickClientBehavior).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<HandleLinkClickClientBehavior>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                HandleLinkClickClientBehavior systemUnderTest1 = null;
                HandleLinkClickClientBehavior systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    HandleLinkClickClientBehavior systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleLinkClickClientBehavior___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleLinkClickClientBehavior___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleLinkClickClientBehavior___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleLinkClickClientBehavior___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleLinkClickClientBehavior___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
