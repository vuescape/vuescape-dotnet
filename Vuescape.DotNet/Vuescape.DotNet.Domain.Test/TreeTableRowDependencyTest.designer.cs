...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<TreeTableRowDependency> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<TreeTableRowDependency>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<TreeTableRowDependency>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<TreeTableRowDependency> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<TreeTableRowDependency>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<TreeTableRowDependency> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<TreeTableRowDependency>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TreeTableRowDependency>
                {
                    Name = "TargetId should return same 'targetId' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<TreeTableRowDependency>();

                        var result = new SystemUnderTestExpectedPropertyValue<TreeTableRowDependency>
                        {
        ...
        private static readonly DeepCloneWithTestScenarios<TreeTableRowDependency> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<TreeTableRowDependency>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TreeTableRowDependency>
                {
                    Name = "DeepCloneWithTargetId should deep clone object and replace TargetId with the provided targetId",
                    WithPropertyName = "TargetId",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TreeTableRowDependency>();

                        var referenceObject = A.Dummy<TreeTableRowDependency>().ThatIs(_ => !systemUnderTest.TargetId.IsEqualTo(_.TargetId));

                        var result = new SystemUnderTestDeepCloneWithValue<TreeTableRowDependency>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.TargetId,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TreeTableRowDependency>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TreeTableRowDependency>().ThatIs(_ => !systemUnderTest.Payload.IsEqualTo(_.Payload));
        ...
        private static readonly TreeTableRowDependency ReferenceObjectForEquatableTestScenarios = A.Dummy<TreeTableRowDependency>();

        private static readonly EquatableTestScenarios<TreeTableRowDependency> EquatableTestScenarios = new EquatableTestScenarios<TreeTableRowDependency>()
            .AddScenario(() =>
                new EquatableTestScenario<TreeTableRowDependency>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new TreeTableRowDependency[]
                    {
        ...
        public static class Structural
        {
            ...
            public static void TreeTableRowDependency___Should_implement_IModel_of_TreeTableRowDependency___When_reflecting()
            {
                // Arrange
                var type = typeof(TreeTableRowDependency);

                var expectedModelMethods = typeof(IModel<TreeTableRowDependency>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<TreeTableRowDependency>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void TreeTableRowDependency___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(TreeTableRowDependency);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (TreeTableRowDependency)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (TreeTableRowDependency)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(TreeTableRowDependency).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<TreeTableRowDependency>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                TreeTableRowDependency systemUnderTest1 = null;
                TreeTableRowDependency systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    TreeTableRowDependency systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TreeTableRowDependency___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TreeTableRowDependency___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TreeTableRowDependency___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TreeTableRowDependency___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TreeTableRowDependency___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
