...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class ReadOnlyFileUploadComponentTest
    {
        ...
        private static readonly ValidModelTestScenarios<ReadOnlyFileUploadComponent> ValidModelTestScenarios = new ValidModelTestScenarios<ReadOnlyFileUploadComponent>()
            .AddScenario(() =>
                new ValidModelTestScenario<ReadOnlyFileUploadComponent>
                {
                    Name = "a dummy ReadOnlyFileUploadComponent should be valid",
                    SystemUnderTest = A.Dummy<ReadOnlyFileUploadComponent>(),
                });
