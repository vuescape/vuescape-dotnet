...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ChicletGridComponentPayload> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ChicletGridComponentPayload>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ChicletGridComponentPayload>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ChicletGridComponentPayload>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ChicletGridComponentPayload>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.ChicletGridComponentPayload: Chiclets = {systemUnderTest.Chiclets?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ChicletGridComponentPayload> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ChicletGridComponentPayload>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ChicletGridComponentPayload>
                {
                    Name = "constructor should throw ArgumentException when parameter 'chiclets' is an empty enumerable scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new ChicletGridComponentPayload(
                                             new List<Chiclet>());
                    ...
                    ExpectedExceptionMessageContains = new[] { "chiclets", "is an empty enumerable", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ChicletGridComponentPayload>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ChicletGridComponentPayload> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ChicletGridComponentPayload>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ChicletGridComponentPayload>
                {
                    Name = "Chiclets should return same 'chiclets' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ChicletGridComponentPayload>();

                        var result = new SystemUnderTestExpectedPropertyValue<ChicletGridComponentPayload>
                        {
                            SystemUnderTest = new ChicletGridComponentPayload(
                                                      referenceObject.Chiclets),
                            ExpectedPropertyValue = referenceObject.Chiclets,
                        };

                        return result;
                    },
                    PropertyName = "Chiclets",
                });

        private static readonly DeepCloneWithTestScenarios<ChicletGridComponentPayload> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ChicletGridComponentPayload>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ChicletGridComponentPayload>
                {
                    Name = "DeepCloneWithChiclets should deep clone object and replace Chiclets with the provided chiclets",
                    WithPropertyName = "Chiclets",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ChicletGridComponentPayload>();

                        var referenceObject = A.Dummy<ChicletGridComponentPayload>().ThatIs(_ => !systemUnderTest.Chiclets.IsEqualTo(_.Chiclets));

                        var result = new SystemUnderTestDeepCloneWithValue<ChicletGridComponentPayload>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Chiclets,
                        };
        ...
        private static readonly ChicletGridComponentPayload ReferenceObjectForEquatableTestScenarios = A.Dummy<ChicletGridComponentPayload>();

        private static readonly EquatableTestScenarios<ChicletGridComponentPayload> EquatableTestScenarios = new EquatableTestScenarios<ChicletGridComponentPayload>()
            .AddScenario(() =>
                new EquatableTestScenario<ChicletGridComponentPayload>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ChicletGridComponentPayload[]
                    {
                        new ChicletGridComponentPayload(
                                ReferenceObjectForEquatableTestScenarios.Chiclets),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ChicletGridComponentPayload[]
                    {
                        new ChicletGridComponentPayload(
                                A.Dummy<ChicletGridComponentPayload>().Whose(_ => !_.Chiclets.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Chiclets)).Chiclets),
                    },
        ...
        private static readonly ValidModelTestScenarios<ChicletGridComponentPayload> ValidModelTestScenarios = new ValidModelTestScenarios<ChicletGridComponentPayload>()
            .AddScenario(() =>
                new ValidModelTestScenario<ChicletGridComponentPayload>
                {
                    Name = "a dummy ChicletGridComponentPayload should be valid",
                    SystemUnderTest = A.Dummy<ChicletGridComponentPayload>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ChicletGridComponentPayload___Should_implement_IModel_of_ChicletGridComponentPayload___When_reflecting()
            {
                // Arrange
                var type = typeof(ChicletGridComponentPayload);

                var expectedModelMethods = typeof(IModel<ChicletGridComponentPayload>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ChicletGridComponentPayload>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ChicletGridComponentPayload___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ChicletGridComponentPayload);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ChicletGridComponentPayload)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.Chiclets == null)
                {
                    actual.Chiclets.AsTest().Must().BeNull();
                }
                else if (!actual.Chiclets.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.Chiclets.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.Chiclets);
                }
            }
            ...
            {
                var propertyNames = new string[] { "Chiclets" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ChicletGridComponentPayload)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ChicletGridComponentPayload).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ChicletGridComponentPayload>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ChicletGridComponentPayload systemUnderTest1 = null;
                ChicletGridComponentPayload systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ChicletGridComponentPayload systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ChicletGridComponentPayload___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ChicletGridComponentPayload___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ChicletGridComponentPayload___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ChicletGridComponentPayload___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ChicletGridComponentPayload___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
