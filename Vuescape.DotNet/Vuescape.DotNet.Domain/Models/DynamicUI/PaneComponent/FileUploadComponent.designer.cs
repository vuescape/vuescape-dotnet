...
namespace Vuescape.DotNet.Domain
{
    ...
    [Serializable]
    public partial class FileUploadComponent : IModel<FileUploadComponent>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="FileUploadComponent"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(FileUploadComponent left, FileUploadComponent right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="FileUploadComponent"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(FileUploadComponent left, FileUploadComponent right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(FileUploadComponent other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as FileUploadComponent);
        ...
        /// <inheritdoc />
        public new FileUploadComponent DeepClone() => (FileUploadComponent)this.DeepCloneInternal();
        ...
        {
            throw new NotSupportedException("The constructor in-use (by code gen) for FileUploadComponent does not have a parameter that corresponds with the 'TypeName' property.  As such, this method, DeepCloneWithTypeName(string typeName), cannot utilize the specified 'typeName' value for that property.");
        }
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public override PaneComponent<FileUploadComponentPayload> DeepCloneWithPayload(FileUploadComponentPayload payload)
        {
        ...
        {
            var result = Invariant($"Vuescape.DotNet.Domain.FileUploadComponent: TypeName = {this.TypeName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Payload = {this.Payload?.ToString() ?? "<null>"}.");
