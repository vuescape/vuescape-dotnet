...
namespace Vuescape.DotNet.Domain
{
    ...
    public partial class TitleComponent : IModel<TitleComponent>
    {
        ...
        /// <returns>New <see cref="TitleComponent" /> using the specified <paramref name="payload" /> for <see cref="Payload" /> and a deep clone of every other property.</returns>
        ...
        public TitleComponent DeepCloneWithPayload(TitleComponentPayload payload)
        {
