...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class TextLinkPayloadTest
    {
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TextLinkPayload>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TextLinkPayload>().ThatIs(_ => !systemUnderTest.Action.IsEqualTo(_.Action));
                ...
                new EquatableTestScenario<TextLinkPayload>
                {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new TextLinkPayload[]
                    {
                        new TextLinkPayload(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Text,
                                A.Dummy<TextLinkPayload>().Whose(_ => !_.Action.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Action)).Action,
                                ReferenceObjectForEquatableTestScenarios.CssStyles,
                                ReferenceObjectForEquatableTestScenarios.CssClass),
                        new TextLinkPayload(
        ...
        private static readonly ValidModelTestScenarios<TextLinkPayload> ValidModelTestScenarios = new ValidModelTestScenarios<TextLinkPayload>()
            .AddScenario(() =>
                new ValidModelTestScenario<TextLinkPayload>
                {
                    Name = "a dummy TextLinkPayload should be valid",
                    SystemUnderTest = A.Dummy<TextLinkPayload>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            {
                var propertyNames = new string[] { "Action", "Id", "Text", "CssStyles", "CssClass" };
