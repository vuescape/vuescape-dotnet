...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly DiscriminatedTypeBase ReferenceObjectForEquatableTestScenarios = A.Dummy<DiscriminatedTypeBase>();

        private static readonly EquatableTestScenarios<DiscriminatedTypeBase> EquatableTestScenarios = new EquatableTestScenarios<DiscriminatedTypeBase>()
            .AddScenario(() =>
                new EquatableTestScenario<DiscriminatedTypeBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new DiscriminatedTypeBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new DiscriminatedTypeBase[]
                    {
                        ...
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithTypeName(A.Dummy<DiscriminatedTypeBase>().Whose(_ => !_.TypeName.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TypeName)).TypeName),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new DiscriminatedTypeBase[]
                    {
                        A.Dummy<DiscriminatedTypeBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class StructuralTesting
        {
            ...
            public static void DiscriminatedTypeBase___Should_implement_IModel_of_DiscriminatedTypeBase___When_reflecting()
            {
                // Arrange
                var type = typeof(DiscriminatedTypeBase);

                var expectedModelMethods = typeof(IModel<DiscriminatedTypeBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<DiscriminatedTypeBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void DiscriminatedTypeBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(DiscriminatedTypeBase);
        ...
        public static class CloningTesting
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<DiscriminatedTypeBase>();

                // Act
                var actual = (DiscriminatedTypeBase)systemUnderTest.Clone();
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<DiscriminatedTypeBase>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                DiscriminatedTypeBase systemUnderTest1 = null;
                DiscriminatedTypeBase systemUnderTest2 = null;
