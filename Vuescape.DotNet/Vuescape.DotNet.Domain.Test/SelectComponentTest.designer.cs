...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class SelectComponentTest
    {
                ...
                new StringRepresentationTestScenario<SelectComponent>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<SelectComponent>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.SelectComponent: TypeName = {systemUnderTest.TypeName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Payload = {systemUnderTest.Payload?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ValidModelTestScenarios<SelectComponent> ValidModelTestScenarios = new ValidModelTestScenarios<SelectComponent>()
            .AddScenario(() =>
                new ValidModelTestScenario<SelectComponent>
                {
                    Name = "a dummy SelectComponent should be valid",
                    SystemUnderTest = A.Dummy<SelectComponent>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            public static void DeepCloneWithTypeName___Should_throw_NotSupportedException___When_called()
            {
                ...
                actual.Message.AsTest().Must().BeEqualTo("The constructor in-use (by code gen) for SelectComponent does not have a parameter that corresponds with the 'TypeName' property.  As such, this method, DeepCloneWithTypeName(string typeName), cannot utilize the specified 'typeName' value for that property.");
            }
        }
