...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<FileUploadComponentPayload> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<FileUploadComponentPayload>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<FileUploadComponentPayload>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<FileUploadComponentPayload> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<FileUploadComponentPayload>()
            .AddScenario(() =>
                ...
                new ConstructorArgumentValidationTestScenario<FileUploadComponentPayload>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new FileUploadComponentPayload(
                                             ...
                                             referenceObject.UploadInstructionText,
                                             referenceObject.MaxFileSizeInBytes,
                                             new string[0].Concat(referenceObject.AcceptFileTypeExtensions).Concat(new string[] { null }).Concat(referenceObject.AcceptFileTypeExtensions).ToList());
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<FileUploadComponentPayload> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<FileUploadComponentPayload>()
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<FileUploadComponentPayload>
                        {
                            SystemUnderTest = new FileUploadComponentPayload(
                                                      ...
                                                      referenceObject.MaxFileSizeInBytes,
                                                      referenceObject.AcceptFileTypeExtensions),
                            ExpectedPropertyValue = referenceObject.IsRequired,
                        };
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<FileUploadComponentPayload>
                {
                    Name = "UploadInstructionText should return same 'uploadInstructionText' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<FileUploadComponentPayload>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<FileUploadComponentPayload>
                        {
                            SystemUnderTest = new FileUploadComponentPayload(
                                                      ...
                                                      referenceObject.MaxFileSizeInBytes,
                                                      referenceObject.AcceptFileTypeExtensions),
                            ExpectedPropertyValue = referenceObject.UploadInstructionText,
                        };

                        return result;
                    },
                    PropertyName = "UploadInstructionText",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<FileUploadComponentPayload>
                {
                    Name = "MaxFileSizeInBytes should return same 'maxFileSizeInBytes' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<FileUploadComponentPayload>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<FileUploadComponentPayload>
                        {
                            SystemUnderTest = new FileUploadComponentPayload(
                                                      ...
                                                      referenceObject.MaxFileSizeInBytes,
                                                      referenceObject.AcceptFileTypeExtensions),
                            ExpectedPropertyValue = referenceObject.MaxFileSizeInBytes,
                        };

                        return result;
                    },
                    PropertyName = "MaxFileSizeInBytes",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<FileUploadComponentPayload>
                {
                    Name = "AcceptFileTypeExtensions should return same 'acceptFileTypeExtensions' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<FileUploadComponentPayload>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<FileUploadComponentPayload>
                        {
                            SystemUnderTest = new FileUploadComponentPayload(
                                                      ...
                                                      referenceObject.MaxFileSizeInBytes,
                                                      referenceObject.AcceptFileTypeExtensions),
                            ExpectedPropertyValue = referenceObject.AcceptFileTypeExtensions,
                        };

                        return result;
                    },
                    PropertyName = "AcceptFileTypeExtensions",
                });

        private static readonly DeepCloneWithTestScenarios<FileUploadComponentPayload> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<FileUploadComponentPayload>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<FileUploadComponentPayload>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<FileUploadComponentPayload>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<FileUploadComponentPayload>
                {
                    Name = "DeepCloneWithIsRequired should deep clone object and replace IsRequired with the provided isRequired",
                    WithPropertyName = "IsRequired",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<FileUploadComponentPayload>();

                        var referenceObject = A.Dummy<FileUploadComponentPayload>().ThatIs(_ => !systemUnderTest.IsRequired.IsEqualTo(_.IsRequired));

                        var result = new SystemUnderTestDeepCloneWithValue<FileUploadComponentPayload>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.IsRequired,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<FileUploadComponentPayload>
                {
                    Name = "DeepCloneWithUploadInstructionText should deep clone object and replace UploadInstructionText with the provided uploadInstructionText",
                    WithPropertyName = "UploadInstructionText",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<FileUploadComponentPayload>();

                        var referenceObject = A.Dummy<FileUploadComponentPayload>().ThatIs(_ => !systemUnderTest.UploadInstructionText.IsEqualTo(_.UploadInstructionText));

                        var result = new SystemUnderTestDeepCloneWithValue<FileUploadComponentPayload>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.UploadInstructionText,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<FileUploadComponentPayload>
                {
                    Name = "DeepCloneWithMaxFileSizeInBytes should deep clone object and replace MaxFileSizeInBytes with the provided maxFileSizeInBytes",
                    WithPropertyName = "MaxFileSizeInBytes",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<FileUploadComponentPayload>();

                        var referenceObject = A.Dummy<FileUploadComponentPayload>().ThatIs(_ => !systemUnderTest.MaxFileSizeInBytes.IsEqualTo(_.MaxFileSizeInBytes));

                        var result = new SystemUnderTestDeepCloneWithValue<FileUploadComponentPayload>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.MaxFileSizeInBytes,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<FileUploadComponentPayload>
                {
                    Name = "DeepCloneWithAcceptFileTypeExtensions should deep clone object and replace AcceptFileTypeExtensions with the provided acceptFileTypeExtensions",
                    WithPropertyName = "AcceptFileTypeExtensions",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<FileUploadComponentPayload>();

                        var referenceObject = A.Dummy<FileUploadComponentPayload>().ThatIs(_ => !systemUnderTest.AcceptFileTypeExtensions.IsEqualTo(_.AcceptFileTypeExtensions));

                        var result = new SystemUnderTestDeepCloneWithValue<FileUploadComponentPayload>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.AcceptFileTypeExtensions,
                        };
        ...
        private static readonly FileUploadComponentPayload ReferenceObjectForEquatableTestScenarios = A.Dummy<FileUploadComponentPayload>();

        private static readonly EquatableTestScenarios<FileUploadComponentPayload> EquatableTestScenarios = new EquatableTestScenarios<FileUploadComponentPayload>()
            .AddScenario(() =>
                new EquatableTestScenario<FileUploadComponentPayload>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new FileUploadComponentPayload[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new FileUploadComponentPayload[]
                    {
                        new FileUploadComponentPayload(
                        ...
                        new FileUploadComponentPayload(
                                ...
                                ReferenceObjectForEquatableTestScenarios.UploadInstructionText,
                                ReferenceObjectForEquatableTestScenarios.MaxFileSizeInBytes,
                                A.Dummy<FileUploadComponentPayload>().Whose(_ => !_.AcceptFileTypeExtensions.IsEqualTo(ReferenceObjectForEquatableTestScenarios.AcceptFileTypeExtensions)).AcceptFileTypeExtensions),
                    },
        ...
        private static readonly ValidModelTestScenarios<FileUploadComponentPayload> ValidModelTestScenarios = new ValidModelTestScenarios<FileUploadComponentPayload>()
            .AddScenario(() =>
                new ValidModelTestScenario<FileUploadComponentPayload>
                {
                    Name = "a dummy FileUploadComponentPayload should be valid",
                    SystemUnderTest = A.Dummy<FileUploadComponentPayload>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void FileUploadComponentPayload___Should_implement_IModel_of_FileUploadComponentPayload___When_reflecting()
            {
                // Arrange
                var type = typeof(FileUploadComponentPayload);

                var expectedModelMethods = typeof(IModel<FileUploadComponentPayload>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<FileUploadComponentPayload>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void FileUploadComponentPayload___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(FileUploadComponentPayload);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (FileUploadComponentPayload)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.AcceptFileTypeExtensions == null)
                {
                    actual.AcceptFileTypeExtensions.AsTest().Must().BeNull();
                }
                else if (!actual.AcceptFileTypeExtensions.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.AcceptFileTypeExtensions.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.AcceptFileTypeExtensions);
                }
            }
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (FileUploadComponentPayload)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(FileUploadComponentPayload).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<FileUploadComponentPayload>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                FileUploadComponentPayload systemUnderTest1 = null;
                FileUploadComponentPayload systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    FileUploadComponentPayload systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FileUploadComponentPayload___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FileUploadComponentPayload___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FileUploadComponentPayload___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FileUploadComponentPayload___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FileUploadComponentPayload___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
