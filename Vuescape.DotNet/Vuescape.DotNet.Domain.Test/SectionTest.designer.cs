...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class SectionTest
    {
                ...
                new StringRepresentationTestScenario<Section>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<Section>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.Section: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, TreeTable = {systemUnderTest.TreeTable?.ToString() ?? "<null>"}, Title = {systemUnderTest.Title?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Id", "TreeTable", "Title" };
