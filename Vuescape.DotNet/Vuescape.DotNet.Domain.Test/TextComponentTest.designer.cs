...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class TextComponentTest
    {
                ...
                new StringRepresentationTestScenario<TextComponent>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<TextComponent>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.TextComponent: TypeName = {systemUnderTest.TypeName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Payload = {systemUnderTest.Payload?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ValidModelTestScenarios<TextComponent> ValidModelTestScenarios = new ValidModelTestScenarios<TextComponent>()
            .AddScenario(() =>
                new ValidModelTestScenario<TextComponent>
                {
                    Name = "a dummy TextComponent should be valid",
                    SystemUnderTest = A.Dummy<TextComponent>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            public static void DeepCloneWithTypeName___Should_throw_NotSupportedException___When_called()
            {
                ...
                actual.Message.AsTest().Must().BeEqualTo("The constructor in-use (by code gen) for TextComponent does not have a parameter that corresponds with the 'TypeName' property.  As such, this method, DeepCloneWithTypeName(string typeName), cannot utilize the specified 'typeName' value for that property.");
            }
        }
