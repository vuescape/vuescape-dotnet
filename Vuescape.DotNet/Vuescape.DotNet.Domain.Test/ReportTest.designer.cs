    ...
    public static partial class ReportTest
    {
                ...
                new StringRepresentationTestScenario<Report>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<Report>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.Report: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Sections = {systemUnderTest.Sections?.ToString() ?? "<null>"}, Title = {systemUnderTest.Title?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, AdditionalReportInfo = {systemUnderTest.AdditionalReportInfo?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, DownloadLinks = {systemUnderTest.DownloadLinks?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Report> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Report>()
                ...
                new ConstructorArgumentValidationTestScenario<Report>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new Report(
                                             ...
                                             referenceObject.AdditionalReportInfo,
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Report>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'additionalReportInfo' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<Report>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "additionalReportInfo", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Report>
                {
                    Name = "constructor should throw ArgumentException when parameter 'additionalReportInfo' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<Report>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "additionalReportInfo", "white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Report>
                {
                ...
                new ConstructorArgumentValidationTestScenario<Report>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new Report(
                                             ...
                                             referenceObject.Title,
                                             referenceObject.AdditionalReportInfo,
                                             new Link[0].Concat(referenceObject.DownloadLinks).Concat(new Link[] { null }).Concat(referenceObject.DownloadLinks).ToList());
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Report> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Report>()
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Report>
                {
                    Name = "AdditionalReportInfo should return same 'additionalReportInfo' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Report>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<Report>
                        {
                            SystemUnderTest = new Report(
                                                      ...
                                                      referenceObject.AdditionalReportInfo,
                                                      referenceObject.DownloadLinks),
                            ExpectedPropertyValue = referenceObject.AdditionalReportInfo,
                        };

                        return result;
                    },
                    PropertyName = "AdditionalReportInfo",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Report>
                {
        ...
        private static readonly DeepCloneWithTestScenarios<Report> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Report>()
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Report>
                {
                    Name = "DeepCloneWithAdditionalReportInfo should deep clone object and replace AdditionalReportInfo with the provided additionalReportInfo",
                    WithPropertyName = "AdditionalReportInfo",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Report>();

                        var referenceObject = A.Dummy<Report>().ThatIs(_ => !systemUnderTest.AdditionalReportInfo.IsEqualTo(_.AdditionalReportInfo));

                        var result = new SystemUnderTestDeepCloneWithValue<Report>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.AdditionalReportInfo,
                        };
                ...
                new EquatableTestScenario<Report>
                {
                    ...
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Report[]
                    {
                        new Report(
                                ...
                                ReferenceObjectForEquatableTestScenarios.AdditionalReportInfo,
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new Report[]
                    {
                        ...
                        new Report(
                                ...
                                ReferenceObjectForEquatableTestScenarios.Sections,
                                ReferenceObjectForEquatableTestScenarios.Title,
                                A.Dummy<Report>().Whose(_ => !_.AdditionalReportInfo.IsEqualTo(ReferenceObjectForEquatableTestScenarios.AdditionalReportInfo)).AdditionalReportInfo,
                                ReferenceObjectForEquatableTestScenarios.DownloadLinks),
                        new Report(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Sections,
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Id", "Sections", "Title", "AdditionalReportInfo", "DownloadLinks" };
