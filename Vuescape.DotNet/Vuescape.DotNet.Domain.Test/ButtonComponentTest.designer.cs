...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ButtonComponent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ButtonComponent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ButtonComponent>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ButtonComponent>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ButtonComponent>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.ButtonComponent: TypeName = {systemUnderTest.TypeName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Payload = {systemUnderTest.Payload?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ButtonComponent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ButtonComponent>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ButtonComponent>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ButtonComponent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ButtonComponent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ButtonComponent>
                {
                    Name = "Payload should return same 'payload' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ButtonComponent>();

                        var result = new SystemUnderTestExpectedPropertyValue<ButtonComponent>
                        {
                            SystemUnderTest = new ButtonComponent(
        ...
        private static readonly DeepCloneWithTestScenarios<ButtonComponent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ButtonComponent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ButtonComponent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ButtonComponent>().ThatIs(_ => !systemUnderTest.Payload.IsEqualTo(_.Payload));

                        var result = new SystemUnderTestDeepCloneWithValue<ButtonComponent>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly ButtonComponent ReferenceObjectForEquatableTestScenarios = A.Dummy<ButtonComponent>();

        private static readonly EquatableTestScenarios<ButtonComponent> EquatableTestScenarios = new EquatableTestScenarios<ButtonComponent>()
            .AddScenario(() =>
                new EquatableTestScenario<ButtonComponent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ButtonComponent[]
                    {
                        new ButtonComponent(
                                ReferenceObjectForEquatableTestScenarios.Payload),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ButtonComponent[]
                    {
                        new ButtonComponent(
                                A.Dummy<ButtonComponent>().Whose(_ => !_.Payload.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Payload)).Payload),
                    },
        ...
        private static readonly ValidModelTestScenarios<ButtonComponent> ValidModelTestScenarios = new ValidModelTestScenarios<ButtonComponent>()
            .AddScenario(() =>
                new ValidModelTestScenario<ButtonComponent>
                {
                    Name = "a dummy ButtonComponent should be valid",
                    SystemUnderTest = A.Dummy<ButtonComponent>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ButtonComponent___Should_implement_IModel_of_ButtonComponent___When_reflecting()
            {
                // Arrange
                var type = typeof(ButtonComponent);

                var expectedModelMethods = typeof(IModel<ButtonComponent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ButtonComponent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ButtonComponent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ButtonComponent);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ButtonComponent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ButtonComponent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ButtonComponent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
            ...
            public static void DeepCloneWithTypeName___Should_throw_NotSupportedException___When_called()
            {
                ...
                actual.Message.AsTest().Must().BeEqualTo("The constructor in-use (by code gen) for ButtonComponent does not have a parameter that corresponds with the 'TypeName' property.  As such, this method, DeepCloneWithTypeName(string typeName), cannot utilize the specified 'typeName' value for that property.");
            }
        }
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ButtonComponent>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ButtonComponent systemUnderTest1 = null;
                ButtonComponent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ButtonComponent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ButtonComponent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ButtonComponent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ButtonComponent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ButtonComponent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ButtonComponent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
