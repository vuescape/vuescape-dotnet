...
namespace Vuescape.DotNet.Domain
{
    ...
    [Serializable]
    public partial class DownloadAction : IModel<DownloadAction>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="DownloadAction"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(DownloadAction left, DownloadAction right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="DownloadAction"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(DownloadAction left, DownloadAction right) => !(left == right);
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as DownloadAction);
        ...
        /// <inheritdoc />
        public new DownloadAction DeepClone() => (DownloadAction)this.DeepCloneInternal();
        ...
        {
            throw new NotSupportedException("The constructor in-use (by code gen) for DownloadAction does not have a parameter that corresponds with the 'TypeName' property.  As such, this method, DeepCloneWithTypeName(string typeName), cannot utilize the specified 'typeName' value for that property.");
        }
        ...
        /// <returns>New <see cref="DownloadAction" /> using the specified <paramref name="payload" /> for <see cref="Payload" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public DownloadAction DeepCloneWithPayload(DownloadActionPayload payload)
        {
        ...
        {
            var result = Invariant($"Vuescape.DotNet.Domain.DownloadAction: TypeName = {this.TypeName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Payload = {this.Payload?.ToString() ?? "<null>"}.");
