...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Tab> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Tab>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Tab>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Tab>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Tab>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.Tab: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Label = {systemUnderTest.Label?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Badge = {systemUnderTest.Badge?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Tab> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Tab>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Tab>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'id' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<Tab>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Tab> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Tab>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Tab>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<Tab>
                        {
                            SystemUnderTest = new Tab(
                                                      referenceObject.Id,
                                                      referenceObject.Label,
                                                      referenceObject.Badge),
        ...
        private static readonly DeepCloneWithTestScenarios<Tab> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Tab>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Tab>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Tab>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<Tab>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Tab>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Tab>().ThatIs(_ => !systemUnderTest.Label.IsEqualTo(_.Label));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Tab>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Tab>().ThatIs(_ => !systemUnderTest.Badge.IsEqualTo(_.Badge));
        ...
        private static readonly Tab ReferenceObjectForEquatableTestScenarios = A.Dummy<Tab>();

        private static readonly EquatableTestScenarios<Tab> EquatableTestScenarios = new EquatableTestScenarios<Tab>()
            .AddScenario(() =>
                new EquatableTestScenario<Tab>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Tab[]
                    {
                        new Tab(
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new Tab[]
                    {
                        new Tab(
                                A.Dummy<Tab>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.Label,
                                ReferenceObjectForEquatableTestScenarios.Badge),
                        new Tab(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<Tab>().Whose(_ => !_.Label.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Label)).Label,
                                ReferenceObjectForEquatableTestScenarios.Badge),
                        new Tab(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Label,
                                A.Dummy<Tab>().Whose(_ => !_.Badge.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Badge)).Badge),
                    },
        ...
        public static class Structural
        {
            ...
            public static void Tab___Should_implement_IModel_of_Tab___When_reflecting()
            {
                // Arrange
                var type = typeof(Tab);

                var expectedModelMethods = typeof(IModel<Tab>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Tab>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Tab___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Tab);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Tab)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Id", "Label", "Badge" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Tab)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(Tab).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Tab systemUnderTest1 = null;
                Tab systemUnderTest2 = null;
