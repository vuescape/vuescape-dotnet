...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class TextComponentPayloadTest
    {
        ...
        private static readonly ValidModelTestScenarios<TextComponentPayload> ValidModelTestScenarios = new ValidModelTestScenarios<TextComponentPayload>()
            .AddScenario(() =>
                new ValidModelTestScenario<TextComponentPayload>
                {
                    Name = "a dummy TextComponentPayload should be valid",
                    SystemUnderTest = A.Dummy<TextComponentPayload>(),
                });
