...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class TableTabsComponentTest
    {
                ...
                new StringRepresentationTestScenario<TableTabsComponent>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<TableTabsComponent>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.TableTabsComponent: TypeName = {systemUnderTest.TypeName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Payload = {systemUnderTest.Payload?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ValidModelTestScenarios<TableTabsComponent> ValidModelTestScenarios = new ValidModelTestScenarios<TableTabsComponent>()
            .AddScenario(() =>
                new ValidModelTestScenario<TableTabsComponent>
                {
                    Name = "a dummy TableTabsComponent should be valid",
                    SystemUnderTest = A.Dummy<TableTabsComponent>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            public static void DeepCloneWithTypeName___Should_throw_NotSupportedException___When_called()
            {
                ...
                actual.Message.AsTest().Must().BeEqualTo("The constructor in-use (by code gen) for TableTabsComponent does not have a parameter that corresponds with the 'TypeName' property.  As such, this method, DeepCloneWithTypeName(string typeName), cannot utilize the specified 'typeName' value for that property.");
            }
        }
