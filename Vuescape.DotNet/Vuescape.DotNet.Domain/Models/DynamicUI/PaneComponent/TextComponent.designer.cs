...
namespace Vuescape.DotNet.Domain
{
    ...
    public partial class TextComponent : IModel<TextComponent>
    {
        ...
        {
            throw new NotSupportedException("The constructor in-use (by code gen) for TextComponent does not have a parameter that corresponds with the 'TypeName' property.  As such, this method, DeepCloneWithTypeName(string typeName), cannot utilize the specified 'typeName' value for that property.");
        }
        ...
        {
            var result = Invariant($"Vuescape.DotNet.Domain.TextComponent: TypeName = {this.TypeName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Payload = {this.Payload?.ToString() ?? "<null>"}.");
