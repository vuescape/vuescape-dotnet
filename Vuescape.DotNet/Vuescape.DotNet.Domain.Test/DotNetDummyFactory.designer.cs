...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    abstract class DefaultDotNetDummyFactory : IDummyFactory
    {
        public DefaultDotNetDummyFactory()
        {
            ...
            AutoFixtureBackedDummyFactory.AddDummyCreator(
                () => new Domain.CellFormat(
                                 A.Dummy<string>(),
                                 A.Dummy<string>(),
                                 A.Dummy<string>(),
                                 A.Dummy<Domain.HorizontalAlignment?>()));
            ...
            AutoFixtureBackedDummyFactory.AddDummyCreator(
                () => new PaneItem(
                                 ...
                                 A.Dummy<string>(),
                                 A.Dummy<Domain.HorizontalAlignment>(),
                                 A.Dummy<Domain.VerticalAlignment>()));
            ...
            AutoFixtureBackedDummyFactory.AddDummyCreator(
                () => new Domain.Report(
                                 A.Dummy<string>(),
                                 A.Dummy<IReadOnlyList<Domain.Section>>(),
                                 A.Dummy<string>(),
                                 A.Dummy<string>(),
