...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly ClientBehaviorBase ReferenceObjectForEquatableTestScenarios = A.Dummy<ClientBehaviorBase>();

        private static readonly EquatableTestScenarios<ClientBehaviorBase> EquatableTestScenarios = new EquatableTestScenarios<ClientBehaviorBase>()
            .AddScenario(() =>
                new EquatableTestScenario<ClientBehaviorBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ClientBehaviorBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ClientBehaviorBase[]
                    {
                        ...
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithName(A.Dummy<ClientBehaviorBase>().Whose(_ => !_.Name.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Name)).Name),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new ClientBehaviorBase[]
                    {
                        A.Dummy<ClientBehaviorBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void ClientBehaviorBase___Should_implement_IModel_of_ClientBehaviorBase___When_reflecting()
            {
                // Arrange
                var type = typeof(ClientBehaviorBase);

                var expectedModelMethods = typeof(IModel<ClientBehaviorBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ClientBehaviorBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ClientBehaviorBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ClientBehaviorBase);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ClientBehaviorBase>();

                // Act
                var actual = (ClientBehaviorBase)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ClientBehaviorBase>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ClientBehaviorBase systemUnderTest1 = null;
                ClientBehaviorBase systemUnderTest2 = null;
