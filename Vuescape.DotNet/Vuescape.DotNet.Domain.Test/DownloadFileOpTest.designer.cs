...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class DownloadFileOpTest
    {
        ...
        private static readonly ValidModelTestScenarios<DownloadFileOp> ValidModelTestScenarios = new ValidModelTestScenarios<DownloadFileOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<DownloadFileOp>
                {
                    Name = "a dummy DownloadFileOp should be valid",
                    SystemUnderTest = A.Dummy<DownloadFileOp>(),
                });
