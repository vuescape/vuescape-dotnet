    ...
    public partial class TableCell : IModel<TableCell>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.RawValue, options, propertyPathTracker, nameof(this.RawValue));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ComparableValue, options, propertyPathTracker, nameof(this.ComparableValue));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
