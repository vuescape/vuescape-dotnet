...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class ConvertObcToVuescapeReportOpTest
    {
        ...
        private static readonly ValidModelTestScenarios<ConvertObcToVuescapeReportOp> ValidModelTestScenarios = new ValidModelTestScenarios<ConvertObcToVuescapeReportOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<ConvertObcToVuescapeReportOp>
                {
                    Name = "a dummy ConvertObcToVuescapeReportOp should be valid",
                    SystemUnderTest = A.Dummy<ConvertObcToVuescapeReportOp>(),
                });
