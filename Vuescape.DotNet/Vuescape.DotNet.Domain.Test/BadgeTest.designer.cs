...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Badge> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Badge>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Badge>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Badge>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Badge>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.Badge: Text = {systemUnderTest.Text?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Severity = {systemUnderTest.Severity?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Badge> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Badge>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Badge>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'text' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<Badge>();

                        var result = new Badge(
                                             null,
                                             referenceObject.Severity);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Badge> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Badge>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Badge>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<Badge>
                        {
                            SystemUnderTest = new Badge(
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Badge>
                {
                    Name = "Severity should return same 'severity' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Badge>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<Badge>
                        {
                            SystemUnderTest = new Badge(
                                                      referenceObject.Text,
                                                      referenceObject.Severity),
                            ExpectedPropertyValue = referenceObject.Severity,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<Badge> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Badge>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Badge>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Badge>().ThatIs(_ => !systemUnderTest.Text.IsEqualTo(_.Text));

                        var result = new SystemUnderTestDeepCloneWithValue<Badge>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Badge>
                {
                    Name = "DeepCloneWithSeverity should deep clone object and replace Severity with the provided severity",
                    WithPropertyName = "Severity",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Badge>();

                        var referenceObject = A.Dummy<Badge>().ThatIs(_ => !systemUnderTest.Severity.IsEqualTo(_.Severity));

                        var result = new SystemUnderTestDeepCloneWithValue<Badge>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Severity,
                        };
        ...
        private static readonly Badge ReferenceObjectForEquatableTestScenarios = A.Dummy<Badge>();

        private static readonly EquatableTestScenarios<Badge> EquatableTestScenarios = new EquatableTestScenarios<Badge>()
            .AddScenario(() =>
                new EquatableTestScenario<Badge>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Badge[]
                    {
                        new Badge(
                                ReferenceObjectForEquatableTestScenarios.Text,
                                ReferenceObjectForEquatableTestScenarios.Severity),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new Badge[]
                    {
                        new Badge(
                                A.Dummy<Badge>().Whose(_ => !_.Text.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Text)).Text,
                                ReferenceObjectForEquatableTestScenarios.Severity),
                        new Badge(
                                ReferenceObjectForEquatableTestScenarios.Text,
                                A.Dummy<Badge>().Whose(_ => !_.Severity.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Severity)).Severity),
                    },
        ...
        private static readonly ValidModelTestScenarios<Badge> ValidModelTestScenarios = new ValidModelTestScenarios<Badge>()
            .AddScenario(() =>
                new ValidModelTestScenario<Badge>
                {
                    Name = "a dummy Badge should be valid",
                    SystemUnderTest = A.Dummy<Badge>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void Badge___Should_implement_IModel_of_Badge___When_reflecting()
            {
                // Arrange
                var type = typeof(Badge);

                var expectedModelMethods = typeof(IModel<Badge>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Badge>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Badge___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Badge);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Badge)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Text", "Severity" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Badge)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(Badge).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                Badge systemUnderTest1 = null;
                Badge systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Badge___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Badge___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Badge___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Badge___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Badge___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
