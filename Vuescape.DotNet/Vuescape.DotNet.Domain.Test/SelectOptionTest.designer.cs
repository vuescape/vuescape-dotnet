...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<SelectOption> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<SelectOption>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<SelectOption>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<SelectOption>();

                        var result = new SystemUnderTestExpectedStringRepresentation<SelectOption>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.SelectOption: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, DisplayName = {systemUnderTest.DisplayName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<SelectOption> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<SelectOption>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SelectOption>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'id' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<SelectOption>();

                        var result = new SelectOption(
                                             null,
                                             referenceObject.DisplayName);
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SelectOption>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'displayName' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<SelectOption>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "displayName", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SelectOption>
                {
                    Name = "constructor should throw ArgumentException when parameter 'displayName' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<SelectOption>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "displayName", "white space", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<SelectOption> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<SelectOption>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SelectOption>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<SelectOption>
                        {
                            SystemUnderTest = new SelectOption(
                                                      referenceObject.Id,
                                                      referenceObject.DisplayName),
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SelectOption>
                {
                    Name = "DisplayName should return same 'displayName' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<SelectOption>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<SelectOption>
                        {
                            SystemUnderTest = new SelectOption(
                                                      referenceObject.Id,
                                                      referenceObject.DisplayName),
                            ExpectedPropertyValue = referenceObject.DisplayName,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<SelectOption> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<SelectOption>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SelectOption>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<SelectOption>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<SelectOption>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SelectOption>
                {
                    Name = "DeepCloneWithDisplayName should deep clone object and replace DisplayName with the provided displayName",
                    WithPropertyName = "DisplayName",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<SelectOption>();

                        var referenceObject = A.Dummy<SelectOption>().ThatIs(_ => !systemUnderTest.DisplayName.IsEqualTo(_.DisplayName));

                        var result = new SystemUnderTestDeepCloneWithValue<SelectOption>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.DisplayName,
                        };
        ...
        private static readonly SelectOption ReferenceObjectForEquatableTestScenarios = A.Dummy<SelectOption>();

        private static readonly EquatableTestScenarios<SelectOption> EquatableTestScenarios = new EquatableTestScenarios<SelectOption>()
            .AddScenario(() =>
                new EquatableTestScenario<SelectOption>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new SelectOption[]
                    {
                        new SelectOption(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.DisplayName),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new SelectOption[]
                    {
                        new SelectOption(
                                A.Dummy<SelectOption>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.DisplayName),
                        new SelectOption(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<SelectOption>().Whose(_ => !_.DisplayName.IsEqualTo(ReferenceObjectForEquatableTestScenarios.DisplayName)).DisplayName),
                    },
        ...
        private static readonly ValidModelTestScenarios<SelectOption> ValidModelTestScenarios = new ValidModelTestScenarios<SelectOption>()
            .AddScenario(() =>
                new ValidModelTestScenario<SelectOption>
                {
                    Name = "a dummy SelectOption should be valid",
                    SystemUnderTest = A.Dummy<SelectOption>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void SelectOption___Should_implement_IModel_of_SelectOption___When_reflecting()
            {
                // Arrange
                var type = typeof(SelectOption);

                var expectedModelMethods = typeof(IModel<SelectOption>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<SelectOption>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void SelectOption___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(SelectOption);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (SelectOption)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Id", "DisplayName" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (SelectOption)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(SelectOption).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<SelectOption>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                SelectOption systemUnderTest1 = null;
                SelectOption systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    SelectOption systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SelectOption___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SelectOption___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SelectOption___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SelectOption___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SelectOption___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
