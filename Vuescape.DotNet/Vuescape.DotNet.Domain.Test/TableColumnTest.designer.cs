...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class TableColumnTest
    {
        ...
        private static readonly ValidModelTestScenarios<TableColumn> ValidModelTestScenarios = new ValidModelTestScenarios<TableColumn>()
            .AddScenario(() =>
                new ValidModelTestScenario<TableColumn>
                {
                    Name = "a dummy TableColumn should be valid",
                    SystemUnderTest = A.Dummy<TableColumn>(),
                });
