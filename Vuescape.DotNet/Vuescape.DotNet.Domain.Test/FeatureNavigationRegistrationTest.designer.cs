...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<FeatureNavigationRegistration> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<FeatureNavigationRegistration>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<FeatureNavigationRegistration>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<FeatureNavigationRegistration> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<FeatureNavigationRegistration>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<FeatureNavigationRegistration> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<FeatureNavigationRegistration>()
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<FeatureNavigationRegistration>
                {
                    Name = "NavigationItems should return same 'navigationItems' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<FeatureNavigationRegistration>();
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<FeatureNavigationRegistration>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<FeatureNavigationRegistration>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<FeatureNavigationRegistration>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<FeatureNavigationRegistration>().ThatIs(_ => !systemUnderTest.NavigationItems.IsEqualTo(_.NavigationItems));
        ...
        private static readonly FeatureNavigationRegistration ReferenceObjectForEquatableTestScenarios = A.Dummy<FeatureNavigationRegistration>();

        private static readonly EquatableTestScenarios<FeatureNavigationRegistration> EquatableTestScenarios = new EquatableTestScenarios<FeatureNavigationRegistration>()
            .AddScenario(() =>
                new EquatableTestScenario<FeatureNavigationRegistration>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new FeatureNavigationRegistration[]
                    {
        ...
        private static readonly ValidModelTestScenarios<FeatureNavigationRegistration> ValidModelTestScenarios = new ValidModelTestScenarios<FeatureNavigationRegistration>()
            .AddScenario(() =>
                new ValidModelTestScenario<FeatureNavigationRegistration>
                {
                    Name = "a dummy FeatureNavigationRegistration should be valid",
                    SystemUnderTest = A.Dummy<FeatureNavigationRegistration>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void FeatureNavigationRegistration___Should_implement_IModel_of_FeatureNavigationRegistration___When_reflecting()
            {
                // Arrange
                var type = typeof(FeatureNavigationRegistration);

                var expectedModelMethods = typeof(IModel<FeatureNavigationRegistration>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<FeatureNavigationRegistration>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void FeatureNavigationRegistration___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(FeatureNavigationRegistration);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (FeatureNavigationRegistration)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.NavigationItems == null)
                {
                    actual.NavigationItems.AsTest().Must().BeNull();
                }
                else if (!actual.NavigationItems.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.NavigationItems.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.NavigationItems);
                }
            }
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (FeatureNavigationRegistration)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(FeatureNavigationRegistration).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<FeatureNavigationRegistration>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                FeatureNavigationRegistration systemUnderTest1 = null;
                FeatureNavigationRegistration systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    FeatureNavigationRegistration systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FeatureNavigationRegistration___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FeatureNavigationRegistration___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FeatureNavigationRegistration___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FeatureNavigationRegistration___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FeatureNavigationRegistration___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
