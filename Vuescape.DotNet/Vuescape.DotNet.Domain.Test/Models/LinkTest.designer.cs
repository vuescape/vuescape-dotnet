...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Link> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Link>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Link>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Link> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Link>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Link> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Link>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Link>
                {
                    Name = "Source should return same 'source' parameter passed to constructor when getting",
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Link>
                {
                    Name = "LinkTarget should return same 'linkTarget' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Link>();
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Link>
                {
                    Name = "ActivatedCssStyles should return same 'activatedCssStyles' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Link>();
        ...
        private static readonly DeepCloneWithTestScenarios<Link> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Link>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Link>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Link>().ThatIs(_ => !systemUnderTest.Title.IsEqualTo(_.Title));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Link>
                {
                    Name = "DeepCloneWithLinkTarget should deep clone object and replace LinkTarget with the provided linkTarget",
                    WithPropertyName = "LinkTarget",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Link>();

                        var referenceObject = A.Dummy<Link>().ThatIs(_ => !systemUnderTest.LinkTarget.IsEqualTo(_.LinkTarget));

                        var result = new SystemUnderTestDeepCloneWithValue<Link>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.LinkTarget,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Link>
                {
                    Name = "DeepCloneWithSource should deep clone object and replace Source with the provided source",
                    WithPropertyName = "Source",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Link>();

                        var referenceObject = A.Dummy<Link>().ThatIs(_ => !systemUnderTest.Source.IsEqualTo(_.Source));

                        var result = new SystemUnderTestDeepCloneWithValue<Link>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Source,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Link>
                {
                    Name = "DeepCloneWithActivatedCssStyles should deep clone object and replace ActivatedCssStyles with the provided activatedCssStyles",
                    WithPropertyName = "ActivatedCssStyles",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Link>();

                        var referenceObject = A.Dummy<Link>().ThatIs(_ => !systemUnderTest.ActivatedCssStyles.IsEqualTo(_.ActivatedCssStyles));

                        var result = new SystemUnderTestDeepCloneWithValue<Link>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ActivatedCssStyles,
                        };
        ...
        private static readonly EquatableTestScenarios<Link> EquatableTestScenarios = new EquatableTestScenarios<Link>()
            .AddScenario(() =>
                new EquatableTestScenario<Link>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Link[]
                    {
                        new Link(
        ...
        private static readonly ValidModelTestScenarios<Link> ValidModelTestScenarios = new ValidModelTestScenarios<Link>()
            .AddScenario(() =>
                new ValidModelTestScenario<Link>
                {
                    Name = "a dummy Link should be valid",
                    SystemUnderTest = A.Dummy<Link>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void Link___Should_implement_IModel_of_Link___When_reflecting()
            {
                // Arrange
                var type = typeof(Link);

                var expectedModelMethods = typeof(IModel<Link>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Link>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Link___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Link);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Link)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.ActivatedCssStyles == null)
                {
                    actual.ActivatedCssStyles.AsTest().Must().BeNull();
                }
                else if (!actual.ActivatedCssStyles.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.ActivatedCssStyles.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.ActivatedCssStyles);
                }
            }
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Link)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(Link).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                Link systemUnderTest1 = null;
                Link systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Link___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Link___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Link___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Link___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Link___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
