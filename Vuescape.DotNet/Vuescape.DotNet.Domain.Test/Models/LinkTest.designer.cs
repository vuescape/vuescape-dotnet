    ...
    public static partial class LinkTest
    {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Link> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Link>()
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Link>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'activatedCssStyles' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<Link>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "activatedCssStyles", },
                });
