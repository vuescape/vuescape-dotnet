...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    public static partial class TreeTableHeaderCellTest
    {
        ...
        private static readonly ValidModelTestScenarios<TreeTableHeaderCell> ValidModelTestScenarios = new ValidModelTestScenarios<TreeTableHeaderCell>()
            .AddScenario(() =>
                new ValidModelTestScenario<TreeTableHeaderCell>
                {
                    Name = "a dummy TreeTableHeaderCell should be valid",
                    SystemUnderTest = A.Dummy<TreeTableHeaderCell>(),
                });
