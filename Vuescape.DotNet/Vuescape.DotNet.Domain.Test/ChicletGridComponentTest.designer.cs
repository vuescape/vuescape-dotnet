...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ChicletGridComponent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ChicletGridComponent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ChicletGridComponent>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ChicletGridComponent>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ChicletGridComponent>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.ChicletGridComponent: TypeName = {systemUnderTest.TypeName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Payload = {systemUnderTest.Payload?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ChicletGridComponent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ChicletGridComponent>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ChicletGridComponent>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'payload' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new ChicletGridComponent(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ChicletGridComponent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ChicletGridComponent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ChicletGridComponent>
                {
                    Name = "Payload should return same 'payload' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ChicletGridComponent>();

                        var result = new SystemUnderTestExpectedPropertyValue<ChicletGridComponent>
                        {
                            SystemUnderTest = new ChicletGridComponent(
        ...
        private static readonly DeepCloneWithTestScenarios<ChicletGridComponent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ChicletGridComponent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ChicletGridComponent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ChicletGridComponent>().ThatIs(_ => !systemUnderTest.Payload.IsEqualTo(_.Payload));

                        var result = new SystemUnderTestDeepCloneWithValue<ChicletGridComponent>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly ChicletGridComponent ReferenceObjectForEquatableTestScenarios = A.Dummy<ChicletGridComponent>();

        private static readonly EquatableTestScenarios<ChicletGridComponent> EquatableTestScenarios = new EquatableTestScenarios<ChicletGridComponent>()
            .AddScenario(() =>
                new EquatableTestScenario<ChicletGridComponent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ChicletGridComponent[]
                    {
                        new ChicletGridComponent(
                                ReferenceObjectForEquatableTestScenarios.Payload),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ChicletGridComponent[]
                    {
                        new ChicletGridComponent(
                                A.Dummy<ChicletGridComponent>().Whose(_ => !_.Payload.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Payload)).Payload),
                    },
        ...
        private static readonly ValidModelTestScenarios<ChicletGridComponent> ValidModelTestScenarios = new ValidModelTestScenarios<ChicletGridComponent>()
            .AddScenario(() =>
                new ValidModelTestScenario<ChicletGridComponent>
                {
                    Name = "a dummy ChicletGridComponent should be valid",
                    SystemUnderTest = A.Dummy<ChicletGridComponent>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ChicletGridComponent___Should_implement_IModel_of_ChicletGridComponent___When_reflecting()
            {
                // Arrange
                var type = typeof(ChicletGridComponent);

                var expectedModelMethods = typeof(IModel<ChicletGridComponent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ChicletGridComponent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ChicletGridComponent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ChicletGridComponent);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ChicletGridComponent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ChicletGridComponent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ChicletGridComponent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
            ...
            public static void DeepCloneWithTypeName___Should_throw_NotSupportedException___When_called()
            {
                ...
                actual.Message.AsTest().Must().BeEqualTo("The constructor in-use (by code gen) for ChicletGridComponent does not have a parameter that corresponds with the 'TypeName' property.  As such, this method, DeepCloneWithTypeName(string typeName), cannot utilize the specified 'typeName' value for that property.");
            }
        }
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ChicletGridComponent>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ChicletGridComponent systemUnderTest1 = null;
                ChicletGridComponent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ChicletGridComponent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneComponent_of_ChicletGridComponentPayload___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    PaneComponent<ChicletGridComponentPayload> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((PaneComponent<ChicletGridComponentPayload>)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneComponent_of_ChicletGridComponentPayload___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((PaneComponent<ChicletGridComponentPayload>)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneComponent_of_ChicletGridComponentPayload___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((PaneComponent<ChicletGridComponentPayload>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneComponent_of_ChicletGridComponentPayload___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((PaneComponent<ChicletGridComponentPayload>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PaneComponent_of_ChicletGridComponentPayload___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((PaneComponent<ChicletGridComponentPayload>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ChicletGridComponent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ChicletGridComponent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ChicletGridComponent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ChicletGridComponent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ChicletGridComponent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
