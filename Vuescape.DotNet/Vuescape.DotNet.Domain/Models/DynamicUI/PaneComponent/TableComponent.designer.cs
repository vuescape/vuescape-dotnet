...
namespace Vuescape.DotNet.Domain
{
    ...
    public partial class TableComponent : IModel<TableComponent>
    {
        ...
        /// <returns>New <see cref="TableComponent" /> using the specified <paramref name="payload" /> for <see cref="Payload" /> and a deep clone of every other property.</returns>
        ...
        public TableComponent DeepCloneWithPayload(TableComponentPayload payload)
        {
