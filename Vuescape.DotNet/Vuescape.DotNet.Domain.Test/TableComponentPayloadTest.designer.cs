...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<TableComponentPayload> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<TableComponentPayload>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<TableComponentPayload>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TableComponentPayload>();

                        var result = new SystemUnderTestExpectedStringRepresentation<TableComponentPayload>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.TableComponentPayload: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Columns = {systemUnderTest.Columns?.ToString() ?? "<null>"}, Rows = {systemUnderTest.Rows?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<TableComponentPayload> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<TableComponentPayload>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<TableComponentPayload> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<TableComponentPayload>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TableComponentPayload>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<TableComponentPayload>
                        {
                            SystemUnderTest = new TableComponentPayload(
                                                      referenceObject.Id,
                                                      referenceObject.Columns,
                                                      referenceObject.Rows),
        ...
        private static readonly DeepCloneWithTestScenarios<TableComponentPayload> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<TableComponentPayload>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableComponentPayload>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TableComponentPayload>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<TableComponentPayload>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableComponentPayload>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TableComponentPayload>().ThatIs(_ => !systemUnderTest.Columns.IsEqualTo(_.Columns));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableComponentPayload>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TableComponentPayload>().ThatIs(_ => !systemUnderTest.Rows.IsEqualTo(_.Rows));
        ...
        private static readonly TableComponentPayload ReferenceObjectForEquatableTestScenarios = A.Dummy<TableComponentPayload>();

        private static readonly EquatableTestScenarios<TableComponentPayload> EquatableTestScenarios = new EquatableTestScenarios<TableComponentPayload>()
            .AddScenario(() =>
                new EquatableTestScenario<TableComponentPayload>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new TableComponentPayload[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new TableComponentPayload[]
                    {
                        new TableComponentPayload(
                                A.Dummy<TableComponentPayload>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.Columns,
                                ReferenceObjectForEquatableTestScenarios.Rows),
                        new TableComponentPayload(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<TableComponentPayload>().Whose(_ => !_.Columns.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Columns)).Columns,
                                ReferenceObjectForEquatableTestScenarios.Rows),
                        new TableComponentPayload(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Columns,
                                A.Dummy<TableComponentPayload>().Whose(_ => !_.Rows.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Rows)).Rows),
                    },
        ...
        private static readonly ValidModelTestScenarios<TableComponentPayload> ValidModelTestScenarios = new ValidModelTestScenarios<TableComponentPayload>()
            .AddScenario(() =>
                new ValidModelTestScenario<TableComponentPayload>
                {
                    Name = "a dummy TableComponentPayload should be valid",
                    SystemUnderTest = A.Dummy<TableComponentPayload>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void TableComponentPayload___Should_implement_IModel_of_TableComponentPayload___When_reflecting()
            {
                // Arrange
                var type = typeof(TableComponentPayload);

                var expectedModelMethods = typeof(IModel<TableComponentPayload>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<TableComponentPayload>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void TableComponentPayload___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(TableComponentPayload);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (TableComponentPayload)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Id", "Columns", "Rows" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (TableComponentPayload)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(TableComponentPayload).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<TableComponentPayload>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                TableComponentPayload systemUnderTest1 = null;
                TableComponentPayload systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    TableComponentPayload systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableComponentPayload___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableComponentPayload___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableComponentPayload___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableComponentPayload___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableComponentPayload___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
