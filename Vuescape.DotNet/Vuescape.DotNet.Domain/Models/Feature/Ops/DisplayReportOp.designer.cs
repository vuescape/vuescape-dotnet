    ...
    public partial class DisplayReportOp : IModel<DisplayReportOp>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.LinkedResource, options, propertyPathTracker, nameof(this.LinkedResource));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.TargetedPaneKind, options, propertyPathTracker, nameof(this.TargetedPaneKind));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.InitialWidth, options, propertyPathTracker, nameof(this.InitialWidth));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.MinimumWidth, options, propertyPathTracker, nameof(this.MinimumWidth));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.MaximumWidth, options, propertyPathTracker, nameof(this.MaximumWidth));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ReportPaneTitleBarButtons, options, propertyPathTracker, nameof(this.ReportPaneTitleBarButtons));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
