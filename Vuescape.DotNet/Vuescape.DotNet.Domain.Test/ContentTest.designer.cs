...
namespace Vuescape.DotNet.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Content> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Content>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Content>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Content>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Content>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Vuescape.DotNet.Domain.Content: Payload = {systemUnderTest.Payload?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, ResourceKind = {systemUnderTest.ResourceKind.ToString() ?? "<null>"}, PayloadEncodingKind = {systemUnderTest.PayloadEncodingKind.ToString() ?? "<null>"}, Metadata = {systemUnderTest.Metadata?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Content> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Content>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Content>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'payload' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<Content>();

                        var result = new Content(
                                             null,
                                             referenceObject.ResourceKind,
                                             referenceObject.PayloadEncodingKind,
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Content>
                {
                    Name = "constructor should throw ArgumentException when parameter 'payload' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<Content>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "payload", "white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Content>
                {
                    Name = "constructor should throw ArgumentOutOfRangeException when parameter 'resourceKind' is ResourceKind.Unknown",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<Content>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Content> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Content>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Content>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<Content>
                        {
                            SystemUnderTest = new Content(
                                                      referenceObject.Payload,
                                                      referenceObject.ResourceKind,
                                                      referenceObject.PayloadEncodingKind,
                                                      referenceObject.Metadata),
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Content>
                {
                    Name = "PayloadEncodingKind should return same 'payloadEncodingKind' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Content>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<Content>
                        {
                            SystemUnderTest = new Content(
                                                      ...
                                                      referenceObject.PayloadEncodingKind,
                                                      referenceObject.Metadata),
                            ExpectedPropertyValue = referenceObject.PayloadEncodingKind,
                        };

                        return result;
                    },
                    PropertyName = "PayloadEncodingKind",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Content>
                {
        ...
        private static readonly DeepCloneWithTestScenarios<Content> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Content>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Content>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Content>().ThatIs(_ => !systemUnderTest.Payload.IsEqualTo(_.Payload));

                        var result = new SystemUnderTestDeepCloneWithValue<Content>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Content>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Content>().ThatIs(_ => !systemUnderTest.ResourceKind.IsEqualTo(_.ResourceKind));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Content>
                {
                    Name = "DeepCloneWithPayloadEncodingKind should deep clone object and replace PayloadEncodingKind with the provided payloadEncodingKind",
                    WithPropertyName = "PayloadEncodingKind",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Content>();

                        var referenceObject = A.Dummy<Content>().ThatIs(_ => !systemUnderTest.PayloadEncodingKind.IsEqualTo(_.PayloadEncodingKind));

                        var result = new SystemUnderTestDeepCloneWithValue<Content>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.PayloadEncodingKind,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Content>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Content>().ThatIs(_ => !systemUnderTest.Metadata.IsEqualTo(_.Metadata));
        ...
        private static readonly Content ReferenceObjectForEquatableTestScenarios = A.Dummy<Content>();

        private static readonly EquatableTestScenarios<Content> EquatableTestScenarios = new EquatableTestScenarios<Content>()
            .AddScenario(() =>
                new EquatableTestScenario<Content>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Content[]
                    {
                        new Content(
                                ReferenceObjectForEquatableTestScenarios.Payload,
                                ReferenceObjectForEquatableTestScenarios.ResourceKind,
                                ReferenceObjectForEquatableTestScenarios.PayloadEncodingKind,
                                ReferenceObjectForEquatableTestScenarios.Metadata),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new Content[]
                    {
                        new Content(
                                A.Dummy<Content>().Whose(_ => !_.Payload.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Payload)).Payload,
                                ReferenceObjectForEquatableTestScenarios.ResourceKind,
                                ReferenceObjectForEquatableTestScenarios.PayloadEncodingKind,
                                ReferenceObjectForEquatableTestScenarios.Metadata),
                        new Content(
                                ReferenceObjectForEquatableTestScenarios.Payload,
                                A.Dummy<Content>().Whose(_ => !_.ResourceKind.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ResourceKind)).ResourceKind,
                                ReferenceObjectForEquatableTestScenarios.PayloadEncodingKind,
                                ReferenceObjectForEquatableTestScenarios.Metadata),
                        new Content(
                                ReferenceObjectForEquatableTestScenarios.Payload,
                                ReferenceObjectForEquatableTestScenarios.ResourceKind,
                                A.Dummy<Content>().Whose(_ => !_.PayloadEncodingKind.IsEqualTo(ReferenceObjectForEquatableTestScenarios.PayloadEncodingKind)).PayloadEncodingKind,
                                ReferenceObjectForEquatableTestScenarios.Metadata),
                        new Content(
                                ReferenceObjectForEquatableTestScenarios.Payload,
                                ReferenceObjectForEquatableTestScenarios.ResourceKind,
                                ReferenceObjectForEquatableTestScenarios.PayloadEncodingKind,
                                A.Dummy<Content>().Whose(_ => !_.Metadata.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Metadata)).Metadata),
                    },
        ...
        private static readonly ValidModelTestScenarios<Content> ValidModelTestScenarios = new ValidModelTestScenarios<Content>()
            .AddScenario(() =>
                new ValidModelTestScenario<Content>
                {
                    Name = "a dummy Content should be valid",
                    SystemUnderTest = A.Dummy<Content>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void Content___Should_implement_IModel_of_Content___When_reflecting()
            {
                // Arrange
                var type = typeof(Content);

                var expectedModelMethods = typeof(IModel<Content>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Content>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Content___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Content);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Content)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Payload", "ResourceKind", "PayloadEncodingKind", "Metadata" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Content)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(Content).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                Content systemUnderTest1 = null;
                Content systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Content___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Content___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Content___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Content___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Content___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
