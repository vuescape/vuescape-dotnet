...
namespace Vuescape.DotNet.Domain
{
    ...
    [Serializable]
    public partial class ReadOnlyFileUploadComponent : IModel<ReadOnlyFileUploadComponent>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ReadOnlyFileUploadComponent"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(ReadOnlyFileUploadComponent left, ReadOnlyFileUploadComponent right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ReadOnlyFileUploadComponent"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ReadOnlyFileUploadComponent left, ReadOnlyFileUploadComponent right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(ReadOnlyFileUploadComponent other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ReadOnlyFileUploadComponent);
        ...
        /// <inheritdoc />
        public new ReadOnlyFileUploadComponent DeepClone() => (ReadOnlyFileUploadComponent)this.DeepCloneInternal();
        ...
        {
            throw new NotSupportedException("The constructor in-use (by code gen) for ReadOnlyFileUploadComponent does not have a parameter that corresponds with the 'TypeName' property.  As such, this method, DeepCloneWithTypeName(string typeName), cannot utilize the specified 'typeName' value for that property.");
        }
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public override PaneComponent<ReadOnlyFileUploadComponentPayload> DeepCloneWithPayload(ReadOnlyFileUploadComponentPayload payload)
        {
        ...
        {
            var result = Invariant($"Vuescape.DotNet.Domain.ReadOnlyFileUploadComponent: TypeName = {this.TypeName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Payload = {this.Payload?.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.TypeName, options, propertyPathTracker, nameof(this.TypeName));
